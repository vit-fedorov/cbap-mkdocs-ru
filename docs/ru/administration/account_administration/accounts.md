...
## Настройка учётных данных для подключений {: .pageBreakBefore }
...
- _[Лицензирование. Активация продукта, использование ключей, назначение, отзыв и продление лицензий][licensing]_
- _[Шаблон аккаунта][account_templates]_
- _[Группы. Создание, настройка, выбор участников, синхронизация с AD, удаление][groups]_
...
- _[Замещения. Создание, настройка, удаление][substitution]_
