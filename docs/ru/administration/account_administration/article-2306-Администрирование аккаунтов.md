...
- [1. Модуль администрирования аккаунтов](#mcetoc_1gmbbekf40)
- [2. Настройка аккаунтов](#mcetoc_1gmbbosh01)
- [3. Настройка групп аккаунтов](#mcetoc_1gmbbqnct2)
	- [3.1. Настройка групп, созданных при синхронизации с Active Directory](#mcetoc_1gmbc359n0)
...
![Жизненный цикл аккаунтов в системе](https://kb.comindware.ru/assets/img_63bc176b4f2e0.png)

Жизненный цикл аккаунтов в системе
