...
1. Чтобы перейти к конструктору страниц входа и регистрации, в разделе [«**Администрирование**» — «**Внешний вид**»][внешний-вид] выберите пункт «**Дизайн страниц входа и регистрации**» <i class=" fal  fa-file-image ">‌</i>.
...
_![Пример опубликованной страницы входа](published_login_page_example.png)_
...
_![Области конструктора страниц входа и регистрации](login_page_design.png)_
...
_![Настройка страницы входа](login_page_heading.png)_
...
_![Настройка информационного блока страницы входа](information_block_properties.png)_
...
_![Настройка заголовка страницы регистрации](registration_page_designer.png)_
...
_![Общие блоки страниц входа и регистрации](login_and_registration_page_blocks.png)_
...
3. Выберите **изображение** логотипа:
    - **Логотип из темы** — изображение логотипа, выбранное в разделе «**[Фирменные изображения][фирменные-изображения]**» текущей [themes][выбор-темы-для-настройки];
    - **Новое изображение** — выберите любой файл типа JPG, GIF, PNG или SVG в соответствии с указанными требованиями к размеру;
...
5. Задайте **цвет текста** под логотипом. Если не задать цвет, то будет использоваться **цвет текста**, заданный в разделе «**[Цвета основных элементов][цвета-основных-элементов]**» текущей темы.

_![Настройка логотипа](logo_properties.png)_
...
_![Настройка блока «Социальные сети»](social_network_properties.png)_  
...
3. Добавьте или удалите элементы в блоке ссылок с помощью кнопок «**Добавить**» ![Кнопка добавления](add_button.png) и «**Удалить**» ![Кнопка удаления](delete_button.png).
...
_![Настройка блока «Ссылки»](link_properties_email.png)_
...
3. Выберите **фон страницы**:
    - **Фон из темы** — в качестве фона страниц будет использоваться **фон страниц**, выбранный в разделе «**[Фирменные изображения][фирменные-изображения]**». Если изображение не задано, будет использоваться **цвет фона страниц**, выбранный в разделе «**[Цвета основных элементов][цвета-основных-элементов]**» текущей [themes][themes];
    - **Новое изображение** — выберите любой файл типа JPG, GIF, PNG или SVG в соответствии с указанными требованиями к размеру;
    - **Без изображения** — укажите **цвет фона** страниц входа и регистрации.

_![Настройка фона страниц входа и регистрации](background_properties_new_image.png)_
