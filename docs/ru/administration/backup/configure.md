...
4. Настройте и сохраните конфигурацию резервного копирования:
    ...
    !!! warning "Путь и имя файла резервной копии по умолчанию"
        ...
        Исходная конфигурация резервного копирования задана в файле конфигурации экземпляра ПО (`<instanceName>.yml`).

        Эти параметры используются по умолчанию при создании конфигураций резервного копирования:
