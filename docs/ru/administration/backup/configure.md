...
!!! warning "Путь и имя файла резервной копии по умолчанию"

    Исходные параметры резервного копирования заданы в файле конфигурации экземпляра ПО (`/usr/share/comindware/configs/instance/<instanceName>.yml`). Эти параметры используются по умолчанию при создании конфигураций резервного копирования.
