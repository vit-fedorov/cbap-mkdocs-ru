...
9. Архив будет распакован в несколько директорий.
    ...
    !!! note "Фактический набор директорий"
        ...
        - Если в резервной копии имеется директория с данными {{ openSearchVariants }}, их следует восстанавливать средствами {{ openSearchVariants }}. См. _«[Восстановление индексов {{ openSearchVariants }} из файла резервной копии репозитория](#backup_restore_cdbbz_indexes)»_.
