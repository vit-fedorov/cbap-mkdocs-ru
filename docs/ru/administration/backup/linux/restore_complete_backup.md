...
3. Если восстановление из резервной копии производится в рамках переноса продукта на чистый экземпляр ПО без базы данных, переходите к [этапу 3](#восстановление-базы-данных-вложенных-файлов-и-журналов-из-полной-резервной-копии).
