...
1. [Создание снимка сервера {{ openSearchVariants }}](#регистрация-репозитория-и-создание-снимка-elasticsearch) — данные истории и мониторинга копируются в отдельную папку.
...
### Регистрация репозитория и создание снимка {{ openSearchVariants }}
