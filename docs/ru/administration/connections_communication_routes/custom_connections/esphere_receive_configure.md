---
title: Получение документов из «СФЕРА Курьер»
kbId: 5061
kbTitle: Получение документов из «СФЕРА Курьер». Настройка подключения, пути передачи данных и сценария
tags:
    - СФЕРА Курьер
...
Имеется шаблон _«Реестр документов из СФЕРА Курьер»_, в котором хранятся сведения о документах, полученных через «СФЕРА Курьер».
...
2. Настройте событие сценария:
    ...
    - **Путь передачи данных:** выберите [путь передачи данных для получения сообщений из системы «СФЕРА Курьер» типа «**Поиск документов**»](#настройка-пути-передачи-данных-для-получения-id-документов)
...
_![Сценарий получения документов из «СФЕРА Курьер»](img/esphere_receive_configure_scenario.png)_
