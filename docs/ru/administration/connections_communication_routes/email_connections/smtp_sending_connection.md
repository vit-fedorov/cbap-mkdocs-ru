---
title: Отправка эл. почты из сценариев через SMTP
kbId: 2584
---

# Отправка эл. почты из сценариев через SMTP. Настройка подключения, пути передачи данных и сценария {: #smtp_sending_connection}
