...
- **Прикреплённые файлы**
  ...
  - **Название документа** — введите строковый литерал с именем файла, включая расширение (заменители не поддерживаются).
  - **Содержимое документа** — введите строку с содержимым файла в формате Base64 (заменители не поддерживаются).
