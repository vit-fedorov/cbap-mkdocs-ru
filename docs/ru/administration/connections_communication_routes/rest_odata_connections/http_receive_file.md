...
В таблицу «**Укажите атрибуты для преобразования составного содержимого запроса**» добавьте атрибут со следующими свойствами:
...
1. В шаблоне _«Реестр вложений»_ создайте атрибут _«Вложение»_ типа «**Документ**».
...
2. Откройте автоматически созданное событие «**Нажатие кнопки**» и настройте его следующим образом:
    ...
    - **Имя переменной:** _Files_ — в эту переменную будет сохраняться объект с полученными данными.
...
4. Добавьте действие «**Проверить результат выражения**» внутри действия «**Повторять по количеству объектов**» со следующими свойствами:
    ...
    - **Выражение: N3**
        ...
        {
            # Находим переменную File из предыдущего действия
...
5. Добавьте действие «**Создать запись**» внутри действия «**Повторять по количеству объектов**» для контекстного шаблона _«Реестр вложений»_.
