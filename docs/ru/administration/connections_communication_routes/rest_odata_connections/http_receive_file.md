...
4. Добавьте действие «**Проверить результат выражения**» внутрь действия «**Повторять по количеству объектов**» со следующими свойствами:
    ...
    - **Выражение: N3**
        ...
        @prefix session: <http://comindware.com/ontology/session#>.
        {
            ...
            # Из ?docs достаём переменную Content
            # и помещаем её в локальную переменную ?Content
            ?docs variable:Content ?Content.
            # Из ?Content достаём содержимое файла
            # и помещаем его в переменную ?ContentValue
            ?Content variable:Content ?ContentValue.
            # Из ?Content достаём название файла
            # и помещаем его в переменную ?Filename
            ?Content variable:Filename ?Filename.
            # Помещаем файл в ?document
            (?ContentValue ?Filename) document:attach ?document.
