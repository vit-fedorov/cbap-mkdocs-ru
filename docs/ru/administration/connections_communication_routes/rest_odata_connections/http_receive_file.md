...
- Имеется шаблон записи _«Реестр документов»_ с атрибутом _«Файлы»_ типа «**Документ**» и текстовым атрибутом _«Описание»_. К каждому документу может быть прикреплено несколько файлов.
...
- Для файлов требуется создать запись в _Реестре документов_, заполнить описание и прикрепить к ней полученные файлы.
...
1. Выберите **тип сообщения** «**Обработка HTTP-запросов с составным содержимым**». Данный тип сообщения позволяет обрабатывать файлы, отправленные с помощью HTTP-запроса, без их преобразования в формат `Base64`.
...
3. Добавьте действие «**Создать запись**» для **контекстного шаблона** _«Реестр документов»_.
...
5. В поле _«Файлы»_ должны отображаться файлы, отправленные с внешнего сервера.
6. В поле _«Описание»_ должно отображаться описание файлов, отправленное с внешнего сервера.
