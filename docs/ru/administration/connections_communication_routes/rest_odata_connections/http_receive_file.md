...
- Требуется настроить получение HTTP-запросов с внешнего сервера: для каждого полученного файла требуется создать запись в _Реестре документов_ и прикрепить к ней полученный файл.
...
3. Остальные полня можно не заполнять.
...
4. Добавьте действие «**Проверить результат выражения**» внутри действия «**Повторять по количеству объектов**» со следующими свойствами:
    ...
    - **Выражение: N3**
        ...
        @prefix session: <http://comindware.com/ontology/session#>.
        {
            ...
            (?FileContent ?Filename) document:attach ?DocumentSDocumentObject.
