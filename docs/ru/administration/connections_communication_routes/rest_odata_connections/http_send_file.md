...
#### Настройка интеграции для сообщений типа «Отправка HTTP-запросов с составным содержимым»
...
#### Настройка интеграции для сообщений типа «Отправка HTTP-запросов»
...
4. Добавьте действие «**Проверить результат выражения**» внутрь действия «**Повторять по количеству объектов**» со следующими свойствами:
    ...
    - На вкладке «**Основные**»:
        ...
        - **Выражение: N3**
            ...
            {
                # Находим атрибут Attachment (Вложение) в шаблоне DocRegistry (Реестр документов).
                ("DocRegistry" "Attachment") object:findProperty ?Attachment.
                # Достаём из ?Attachment содержимое в ?AttachmentItem.
                ?item ?Attachment ?AttachmentItem.
                # Достаём из ?AttachmentItem содержимое файла в ?Content.
                ?AttachmentItem document:content ?Content.
                # Достаём из ?AttachmentItem имя файла в ?Content.
