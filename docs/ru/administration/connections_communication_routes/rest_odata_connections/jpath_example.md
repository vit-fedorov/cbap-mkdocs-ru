...
6. Внутри действия «**Создать запись**» добавьте действие «**Изменить значения атрибутов**» с установленным флажком «**Сбрасывать кэш значений**».
7. В действии «**Изменить значения атрибутов**» добавьте атрибуты, значения которых требуется изменить:
