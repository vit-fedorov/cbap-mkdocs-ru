...
!!! tip "Обращение к данным с помощью JSONPath"
    ...
    Чтобы обратиться к определённым сегментам данных, полученных из JSON, можно составить различные варианты запросов с помощью JSONPath:
    ...
    Вот некоторые примеры запросов, составленных с помощью JSONPath, и возвращаемых значений:
