...
Пример в статье приведён для СУБД MySQL. Настройка приложения для обмена данными с СУБД MySQL, MSSQL, Oracle и PostgreSQL осуществляется аналогичным образом.
...
{: #step11}
    ...
    - Нажмите кнопку «**Сохранить**».  
        ...
        _![Настройка цикла по объектам в сценарии](img/sql_receive_connection_scenario_cycle_scenario.png)_
