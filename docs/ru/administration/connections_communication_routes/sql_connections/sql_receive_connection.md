...
10. Настройте свойства события:
{: #start_event .pageBreakBefore }
...
11. Нажмите кнопку «**Добавить действие**» под элементом «**Получение сообщения**».  

    _![Добавление действия в сценарий](img/sql_receive_connection_scenario_add.png)_

12. Добавьте действие «**Повторять по количеству объектов**» и настройте его:
{: #object_cycle}
...
13.  Добавьте в действие «**Повторять по количеству объектов**» вложенное действие «**Создать запись**» и настройте его:
{: #create_record}
