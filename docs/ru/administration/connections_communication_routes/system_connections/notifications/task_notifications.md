...
!!! warning "Внимание!"
    ...
    Чтобы отправлять стандартные или особые уведомления о пользовательских задачах, необходимо настроить [конфигурационный файл экземпляра ПО][configuration_files_linux].
