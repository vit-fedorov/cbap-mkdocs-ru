...
- _Сервис полнотекстового индекса_: Platform V Search, OpenSearch или Elasticsearch.
- _Сервис сбора и анализа журналов транзакционных данных и данных мониторинга Системы_: Platform V Monitor, Platform V Audit, Platform V Search, OpenSearch или Elasticsearch, Kibana.
...
- _Сервер полнотекстового индекса (Platform V Search, OpenSearch или Elasticsearch)_ — в конфигурации с одним узлом.
...
- _Сервер полнотекстового индекса (Platform V Search, OpenSearch или Elasticsearch)_.
...
### Методика расчета требуемых аппарат-ных ресурсов {: .pageBreakBefore }
...
<tr markdown>
<td colspan="7" markdown>
**Сервер полнотекстового индекса (VPS): `OpenSearch`**
</td>
</tr>
<tr markdown>
<td markdown>4</td>
...
### Конфигурация сервера полнотекстового сервиса

Сервер полнотекстового индекса (Platform V Search, OpenSearch или Elasticsearch) в минимально необходимой конфигурации можно установить автоматически при развертывании **{{ productName }}** либо самостоятельно в требуемой конфигурации.
...
- Мониторинг доступности сервера полнотекстового индекса (Platform V Search, OpenSearch или Elasticsearch)
    - Сервер может быть недоступен из-за проблем с сетью.
    - На сервере может закончиться свободное место на диске.
