...
- *Модули для интеграции*: см. раздел «[Интеграция с внешними системами](#12-интеграция-с-внешними-системами)».
...
Подсистемы (см. раздел «[Конфигурация подсистем](#4-конфигурация-подсистем)») и виртуальные машины с Продуктом рекомендуется размещать на нескольких физических машинах.
...
1. Развертывание одного узла в Windows: см. статью [Установка Elasticsearch. Краткое руководство для Windows]({{ kbArticleURLPrefix }}2094).
2. Развертывание кластера в Linux: см. статью [Установка Elasticsearch и настройка кластера Elasticsearch без сертификатов подлинности]({{ kbArticleURLPrefix }}2095).
...
См. статью [Zabbix. Установка и настройка. Краткое руководство]({{ kbArticleURLPrefix }}2098).
