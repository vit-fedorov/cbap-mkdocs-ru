...
1. Откройте файл конфигурации {{ openSearchVariants }}: `/etc/opensearch/opensearch.yml`
...
1. Откройте файл конфигурации JVM {{ openSearchVariants }}: `/etc/opensearch/jvm.options`
