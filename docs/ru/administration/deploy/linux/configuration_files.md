...
!!! note "Обновление конфигурации системных служб с версии 4.7 или 5.0"

    Инструкции по обновлению конфигурации с версий 4.7.x или 5.0 на версию {{ productVersion }} см. в статье _«[Обновление версии экземпляра ПО с его остановкой][upgrade_version_linux]»_.
