...
!!! warning "Внимание!"
    ...
    Если продуктовый контур Системы изолирован внешним межсетевым экраном, необходимо настроить правила фильтрации для разрешения входящего HTTP/HTTPS и WS/WSS трафика в контур Системы.
