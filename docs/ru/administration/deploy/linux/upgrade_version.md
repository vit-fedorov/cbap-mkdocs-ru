...
Инструкции даны для обновления с версии 4.7.2 и выше на версию {{ productVersion }} в ОС Linux.
...
3. Отредактируйте файлы конфигурации в соответствии с резервными копиями, [сохранёнными ранее](#ConfigBackup):
    ...
    !!! note "Восстановление резервной копии на другом экземпляре ПО"
...
!!! warning "Обновление с версии 4.7 или 5.0 на версию {{ productVersion }}"

    При обновлении с версии 4.7 или 5.0 на версию {{ productVersion }} обновляется структура базы данных.
...
4. Проверьте результат обновления структуры данных.
    ...
    - **Если обновление структуры данных выполнено успешно:**
        ...
        - При обновлении с версии {{ productVersion }}:
        ...
        - При обновлении с версии 4.7 или 5.0 на версию {{ productVersion }}:
