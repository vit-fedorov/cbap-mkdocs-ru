...
1. Подготовьте DNS-записи и конфигурацию вышестоящего прокси-сервера с IP-адресом нового экземпляра для переключения.
2. Выполните переключение:
    ...
    - **Вышестоящий прокси:**
        - смените IP-адрес старого экземпляра на адрес нового.
