...
- исправность пользовательского адаптера: `adapter_external_heartbeat_ГГГГ-ММ-ДД.log`
- подключение пользоввательского адаптера к брокеру сообщений: `adapter_external_kafkaClient_ГГГГ-ММ-ДД.log`
