...
Каждый журнал формируется как один файл на каждый день.

По умолчанию ПО сохраняет в директории `Logs` до 50 файлов журнала каждого типа (кроме журнала интеграции с сырыми данными, см. _[«Журнал интеграции с сырыми данными»](#журнал-интеграции-с-сырыми-данными)_), а остальные будут удаляться в очерёдности их создания.
