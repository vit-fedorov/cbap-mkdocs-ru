...
Для быстрого развёртывания **{{ productName }}** компания **{{ companyName }}** предоставляет дистрибутив со скриптами, настраивающими необходимое программное обеспечение.

Здесь представлены сведения о ключах, которые поддерживают эти скрипты для настройки конфигурации ПО.
