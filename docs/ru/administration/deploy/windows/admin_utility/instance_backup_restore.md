...
# Восстановление экземпляра продукта из резервной копии в ОС Windows {: #admin_utility_instance_backup_restore }
...
- _[Резервное копирование. Настройка и запуск][backup_configure]_
- _[Резервное копирование и восстановление {{ productName }}. Краткое руководство для ОС Windows][backup_restore_windows]_
