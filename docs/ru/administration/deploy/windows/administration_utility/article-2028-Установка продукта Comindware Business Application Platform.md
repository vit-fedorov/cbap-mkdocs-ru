...
См. также параграф *«[Использование службы Elasticsearch, установленной Утилитой администрирования](#использование-службыelasticsearch-установленнойутилитой-администрирования)»*.
