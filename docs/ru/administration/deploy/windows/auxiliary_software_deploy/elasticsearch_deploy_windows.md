...
Здесь представлены инструкции по установке Elasticsearch с помощью дистрибутива **{{ productName }}** в базовой конфигурации: без использования протоколов TLS/SSL и с одним узлом по адресу `localhost:9201`.
