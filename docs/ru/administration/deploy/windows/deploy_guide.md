...
2. Нажмите пункт «**Добавить роли и компоненты**».
3. Укажите тип установки «**Установка ролей или компонентов**».
4. Выберите ваш сервер в качестве **целевого**.
5. Перейдите к пункту «**Роли сервера**»..
6. Установите флажок «**Веб-сервер (IIS)**».
7. Выберите «**Веб-сервер (IIS)**» — «**Веб-сервер**» — «**Разработка приложений**».
8. Укажите флажки у следующих компонентов:
...
9. Нажмите кнопку «**Установить**» и дождитесь завершения процесса.
