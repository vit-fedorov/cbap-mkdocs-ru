...
3. Выберите пункт «**Добавить роли и компоненты**» для данного сервера.
4. Укажите тип установки «**Установка ролей или компонентов**».
5. Выберите сервер, на котором будет установлено ПО, в качестве **целевого**.
6. Перейдите к пункту «**Роли сервера**»..
7. Установите флажок «**Веб-сервер (IIS)**».
8. У параметра «**Веб-сервер (IIS)**» — «**Веб-сервер**» — «**Разработка приложений**» установите флажки для следующих компонентов:
