...
- [Переход к окну «Конфигурация утилиты администрирования»](#mcetoc_1i177mrs11)
- [Просмотр статуса и установка компонентов продукта](#mcetoc_1i1784pft2)
- [Настройка службы IIS](#mcetoc_1i178lg9s3)
- [Настройка путей](#mcetoc_1i17ge5hu0)
- [Диагностика утилиты администрирования](#mcetoc_1i179vpnc5)
- [Связанные статьи](#mcetoc_1i177l4bp0)
...
- просмотреть статус компонентов Comindware Business Application Platform и установить недостающие компоненты;
...
2. В таблице «**Статус компонентов продукта**» отобразится перечень стороннего ПО, необходимого для работы **Comindware Business Application Platform**.
