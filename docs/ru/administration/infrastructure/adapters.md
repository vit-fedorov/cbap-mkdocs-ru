...
- службы, обеспечивающие за взаимодеиствие с Kestrel, отправку сообщений, таймауты, проверку данных и т. д.
...
- `{AdapterName}` — проект с бизнес-логикой адаптера для [получения](#adapters_incoming_classes) и [отправки](#adapters_outgoing_classes) сообщений.
