...
1. В разделе [«**Администрирование**» — «**Инфраструктура**»][инфраструктура] выберите пункт «**Лицензирование**» <i class="fa-light  fa-key"></i>.
...
_![Список лицензионных ключей](licensing_key_list.png)_
...
2. Отобразится окно «**Активация {{ productName }}** ».
    ...
    _![Активация лицензионных ключей. Способ активации](license_key_activation_1.png)_
...
1. Выберите пункт «**Онлайн-активация**» на шаге «**1. Способ активации**» в окне «**Активация {{ productName }}**».
    ...
    _![Активация лицензионных ключей. Способ активации: онлайн-активация](license_key_activation_1.png)_

2. Нажмите кнопку «**Продолжить**».
    
    _![Онлайн-активация. Проверка ключей](license_key_activation_2.png)_
...
5. В случае успешной активации отобразится сообщение «**Продукт активирован**».
    ...
    _![Онлайн-активация. Продукт активирован](license_key_activation_3.png)_

### Ручная активация

1. Выберите пункт «**Ручная активация**» на шаге «**1. Способ активации**» в окне «**Активация {{ productName }}**».

    _![Активация лицензионных ключей. Способ активации: ручная активация](license_key_activation_manual_1.png)_
...
3. Если у вас нет файла ответа активации, Нажмите кнопку «**Продолжить**».
    ...
    _![Ручная активация. Формирование запроса активации](license_key_activation_manual_2.png)_
...
5. Нажмите кнопку «**Сгенерировать файл запроса активации**».
    ...
    _![Ручная активация. Получение ответа](license_key_activation_manual_3.png)_

6. На шаге «**3. Получение ответа**» скачайте файл запроса активации, нажав кнопку «**Скачать файл запроса активации**».
{: #получение-ответа }
1. Загрузите файл запроса активации в личный кабинет 7. Загрузите файл запроса активации в личный кабинет **{{ companyName }}**.
.
2. Получите в личном кабинете **{{ companyName }}** файл ответа активации.
3.  Загрузите полученный файл ответа активации, нажав кнопку «**Выберите файл**».
4.  Нажмите кнопку «**Активировать продукт**».
5.  В случае успешной активации отобразится сообщение «**Продукт активирован**».
    
    _![Ручная активация. Продукт активирован](license_key_manual_activation_4.png)_
...
_![Свойства лицензионного ключа](license_key_properties.png)_
...
_![Назначение именных лицензий](license_named_making.png)_
...
!!! warning "Логика назначения конкурентных лицензий участникам группы"
    ...
    **Исходные данные**
    ...
    - Имеются _Группа 1_, в которую входят _Пользователи 1 и 2,_ и _Группа 2_ с _Пользователями 4, 6 и 7_.
...
_![Назначение конкурентных лицензий аккаунтам и группам](license_named_compete.png)_
...
_![Отзыв лицензий](license_recall.png)_
