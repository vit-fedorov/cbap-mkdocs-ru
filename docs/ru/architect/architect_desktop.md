...
Сведения об использовании и настройке Рабочего стола см. в разделах «_[Использование системы — Рабочий стол][desktop]_» и «_[Настройка панели навигации — Рабочий стол][desktop_setup]_».
...
**[Настройка панели навигации — Рабочий стол][desktop_setup]**
