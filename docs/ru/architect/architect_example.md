...
Модуль **Architect** позволяет [импортировать][importing_process_entity] и интегрировать готовые диаграммы процессов.

1. Нажмите на три точки у раздела «**Реестр**» и выберите «**Импорт в списке**».

	_![](architect_example_import_button.png)_

2. Выберите пункт «**Загрузить файлы BPMN**» и добавьте схемы `Поиск_найм кандидатов.bpmn`, `Просмотр и отбор кандидатов.bpmn` и `Управление_заявками_на_найм_персонала.bpmn`.

	_![](architect_example_import_files.png)_

3. Нажмите кнопку «**Продолжить**».
4. Выберите процессы, которые хотите добавить, и нажмите кнопку «**Импортировать**».

	_![](architect_example_import_choice.png)_

5. Готовые диаграммы будут добавлены в реестр процессов.

	_![](architect_example_process_registry.png)_

6. В журнале действий и ошибок отобразится сообщение об успешном импорте диаграмм.
...
**[Редактирование диаграммы][architect_diagram_configure]**

**[Построение организационной структуры][построение-организационной-структуры]**

**[Создание оргединицы][architect_organizational_unit_create]**

**[Редактирование формы и атрибутов оргединицы][architect_form_attribute_organizational_unit_configure]**
