...
1. Выберите оргединицу в [панели навигации][использование-панели-навигации] или в [реестре оргединиц][просмотр-реестра-оргединиц].
...
4. Отобразится [конструктор формы](form_designer.md).
...
**[Конструктор формы](form_designer.md)**
