...
- Для построения организационно-штатной структуры (ОШС) в **{{ productNameEnterprise }}** предусмотрены следующие инструменты:
    ...
    - [конструктор диаграммы ОШС][architect_organiztional_structure_designer].
...
Чтобы отредактировать оргструктуру предприятия, отройте [реестр организационных единиц](#просмотр-реестра-оргединиц).
...
## Просмотр реестра оргединиц {: #architect_organizational_structure_design_view_registry .pageBreakBefore }
...
## Изменение цвета и размера оргединицы на диаграмме ОШС {: #architect_organizational_unit_change_color_resize .pageBreakBefore }
