...
# Диаграмма процесса. Определения, просмотр, редактирование, публикация {: #process_diagram_view}
...
3. Отобразится диаграмма процесса в режиме просмотра со следующими кнопками:
    - Операций с диаграммой
        ...
        - **Редактировать** — переход к [конструктору диаграммы процесса][diagram_constructor].
    - Масштабирование диаграммы
        ...
        Масштабировать диаграмму также можно с помощью колёсика прокрутки мыши. Перемещать видимую область диаграммы можно, нажав и перетащив её пустую область.

_![Диаграмма шаблона процесса в режиме просмотра](process_diagram_view.png)_

## Переход к конструктору диаграммы процесса {: #diagram_constructor}

Конструктор диаграммы процесса позволяет [редактировать диаграмму][process_diagram_view]  путем перетаскивания необходимых элементов и настроить логику исполнения процесса.
...
5. [Отредактируйте диаграмму процесса][process_diagram_view].

_![Конструктор диаграммы процесса](process_diagram_designer.png)_
...
2. **Панель элементов** — содержит [элементы][process_diagram_view], которые можно перетащить на диаграмму процесса.
...
6. **Меню элемента** — содержит команды для работы с выбранным элементом. См. «_[Вызов меню элемента][call_element_menu]_».
...
_![Добавление элемента на диаграмму](process_diagram_designer_add_element.png)_

## Вызов меню элемента {: #call_element_menu}
...
_![Меню элемента диаграммы](process_diagram_designer_element_menu.png)_
...
Выберите один или несколько элементов и перетащите их в требуемую позицию на диаграмме.
...
1. Дважды нажмите название элемента на диаграмме или нажмите кнопку «**Свойства**» <i class="fa-light fa-gear">‌&nbsp;</i> в меню элемента.
2. Введите новое название элемента.

## Удаление элемента

1. Выберите один или несколько элементов.
2. В отобразившемся меню элемента нажмите кнопку «**Удалить**» <i class="fa-light fa-trash-can">‌</i> или нажмите клавишу Del.
3. Подтвердите удаление элементов.

## Публикация диаграммы процесса

1. Откройте [конструктор диаграммы][diagram_constructor].
2. Нажмите кнопку «**Опубликовать**».
3. Будет выполнена проверка диаграммы.
...
Перед публикацией диаграммы будет автоматически выполнена её проверка.
...
- Для просмотра списка [сообщений об ошибках][error_messages] нажмите флаг <i class="fa-light fa-flag">‌</i> в верхней информационной панели.
...
_![Просмотр ошибок диаграммы процесса](process_diagram_validation_errors.png)_

## Типичные ошибки диаграммы процесса {: #error_messages}
...
**[Стартовая форма и форма пользовательской задачи][start_form_user_task_form]**
