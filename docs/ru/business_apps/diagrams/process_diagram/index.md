...
## Переход к конструктору диаграммы процесса {: #process_diagram_designer}
...
5. [Отредактируйте диаграмму процесса][process_diagram_designer].
...
6. **Меню элемента** — содержит команды для работы с выбранным элементом. См. «_[Вызов меню элемента][process_diagram_call_element_menu]_».
...
## Вызов меню элемента {: #process_diagram_call_element_menu}
