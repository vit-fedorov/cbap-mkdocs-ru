---
title: Отладка сценариев, скриптов, формул и N3
kbId:
tags:
    - формулы
    - формула
...
# Отладка сценариев, скриптов, формул и выражений N3

## Введение

В **{{ productName }}** можно настроить атрибуты, сценарии, вызов процессов, задачи, фильтры, кнопки и правила на форме c помощью C#-скриптов, формул и выражений N3. Однако при их составлении могут возникнуть проблемы различного рода, например:
...
Ошибки могут содержаться в названиях функций, формул и переменных или в синтаксисе. Чтобы выявить ошибки такого рода, используйте проверку скрипта, выражения N3 или формулы в **[редакторе выражений][expression_editor]**.

!!! warning "Внимание!"

    Компактный редактор выражений не показывает ошибки и сохраняет скрипты, формулы и выражения N3 с ними.
