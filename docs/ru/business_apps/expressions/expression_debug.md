...
Это особенно актуально для правил на форме, фильтров таблиц, вычислений в шаблонах процессов и сценариев, результат выполнения которых визуально не отображается. Вспомогательный отладочный атрибут позволяет сэкономить ресурсы приложения, которые уходят на обновление диаграмм процессов, сценариев, правил и фильтров, а также ускорить поиск ошибок.
...
!!! warning "Контекст выполнения"

    При использовании формул и выражений N3 в сценарии важно обратить внимание на контекст, в котором они выполняются. Любая смена контекста может привести к тому, что формулы и выражения N3 перестанут работать.

    Следующие действия приводят к смене контекста:
