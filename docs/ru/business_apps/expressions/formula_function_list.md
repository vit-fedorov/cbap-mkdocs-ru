...
Принимает аргумент типа «**Дата и время**» и возвращает число, соответствующее векуаргумента.
...
Принимает логический аргумент и выполняет над ним операцию отрицания.
...
Принимает строку и регулярное выражение. Возвращает логическое значение `True`, если часть строки или вся строка не соответствует регулярному выражениб. В противном случае возвращает `False`.
