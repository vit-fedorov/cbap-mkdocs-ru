...
Прибавляет указанное количество дней к значению типа «**Дата и время**» и преобразует результат в часовой пояс `UTC+00:00`.
...
Прибавляет указанное количество часов к значению типа «**Дата и время**» и преобразует результат в часовой пояс `UTC+00:00`.
...
Прибавляет указанное количество минут к значению типа «**Дата и время**» и преобразует результат в часовой пояс `UTC+00:00`.
...
Прибавляет указанное количество месяцев к значению типа «**Дата и время**» и преобразует результат в часовой пояс `UTC+00:00`.
...
Прибавляет указанное количество секунд к значению типа «**Дата и время**» и преобразует результат в часовой пояс `UTC+00:00`.
...
Прибавляет значение типа «**Длительность**» к значению типа «**Дата и время**» и преобразует результат в часовой пояс `UTC+00:00`.
...
Прибавляет указанное количество лет к значению типа «**Дата и время**» и преобразует результат в часовой пояс `UTC+00:00`.
...
Берёт список логических переменных и возвращает `True`, если все переменные имеют значение `True`.
...
`list`: список логических значений или выражений, возвращающих логические значения.
...
Берёт два логических значения или два выражения, возвращающих логические значения, и возвращает результат логического умножения (конъюнкции) этих значений.
...
Проверяет список или набор данных на наличие значений.
...
- `sequence`: набор данных, например сформированный с помощью запроса вида `from ... where ... select`.
...
Результат: `True`, если хотя бы один в одном элементе выборки `product` имеет значение `Data Monsoon`.
...
Формирует набор данных и проверяет, что в нем есть хотя бы один элемент с истинным значением заданного предиката.
...
- `query`: набор данных, сформированный с помощью запроса вида `from ... where ... select`.
...
Результат: `True`, если запрос вернул хотя бы один элемент с `product` равным `Data Monsoon`, для которого значение атрибута `NeedsQAHelp` равно `True`.
...
Проверяет факт вхождения значения типа «**Дата и время**» или «**Длительность**» в заданный диапазон.
...
Проверяет факт вхождения даты или длительности в заданный диапазон. Значения типа «**Дата и время**» приводятся к часовому поясу `UTC+00:00`.
...
Принимает аргумент типа «**Дата и время**» и возвращает числовое значение, соответствующее веку указанной даты.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает числовое значение, соответствующее веку указанной даты.
...
Преобразует значение типа «**Дата и время**» в заданный часовой пояс в формате IANA.
...
Преобразует значение типа «**Дата и время**» в часовой пояс `UTC+00:00` и в заданный часовой пояс в формате IANA.
...
- `date` — дата с указанием часового пояса.
- `timeZone` — целевой часовой пояс.
...
Преобразует числовые аргументы в значение типа «**Дата и время**» в часовом поясе `UTC+00:00`.
...
Принимает аргумент типа «**Дата и время**» и часовой пояс в формате IANA и возвращает числовое значение, соответствующее дню месяца указанной даты.
...
<td markdown="block">
Принимает аргумент типа «**Дата и время**» и возвращает название дня недели указанной даты.
...
Принимает аргумент типа «**Дата и время**» преобразует его в часовой пояс `UTC+00:00` и возвращает название дня недели указанной даты.
...
<td markdown="block">
Принимает аргумент типа «**Дата и время**» и возвращает число, соответствующее дню года указанной даты.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает число, соответствующее дню года результирующей даты.
...
<td markdown="block">
Принимает аргумент типа «**Дата и время**» или два аргумента типа «**Число**» и возвращает число, соответствующее количеству дней в месяце указанной даты.
...
Принимает аргумент типа «**Дата и время**» или два аргумента типа «**Число**», указывающие год и месяц. Преобразует дату и время в часовой пояс `UTC+00:00`. Возвращает число, соответствующее количеству дней в месяце указанной даты.
...
Принимает аргумент типа «**Дата и время**», и возвращает дату и время окончания дня, на который приходится значение аргумента.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает дату и время окончания дня, на который приходится результирующее значение.
...
<td markdown="block">
Принимает аргумент типа «**Дата и время**», и возвращает дату и время окончания месяца, на который приходится значение аргумента.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает дату и время окончания месяца, на который приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**», и возвращает дату и время окончания квартала, на который приходится значение аргумента.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает дату и время окончания квартала, на который приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**», и возвращает дату и время окончания недели, на которую приходится значение аргумента.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает дату и время окончания недели, на которую приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**» и возвращает дату и время окончания года, на который приходится значение аргумента.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает дату и время окончания года, на которые приходится результирующее значение.
...
Результат при UTC+03:00 на сервере0: `31.12.2024 23:59:59`
...
Преобразует значение типа «**Дата и время**» в строку заданного формата.
...
Преобразует значение типа «**Дата и время**» в строку заданного формата в часовом поясе `UTC+00:00`.
...
Вычисляет длительность между значениями двух аргументов типа «**Дата и время**». Значения аргументов преобразуются в часовой пояс `UTC+00:00`.
...
Сравнивает значения двух аргументов типа «**Дата и время**». Возвращает логическое значение `True`, если первый аргумент больше или равен второму, в противном случае возвращает `False`. Значение аргументов преобразуются в часовой пояс `UTC+00:00`.
...
Возвращает логическое значение `True`, если значение первого аргумента типа «**Дата и время**» больше значения второго, в противном случае возвращает результат `False`. Значение аргументов преобразуются в часовой пояс `UTC+00:00`.
...
Принимает аргумент типа «**Дата и время**» и возвращает числовое значение, соответствующее часу указанной даты.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает числовое значение, соответствующее часу результирующей даты.
...
- Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает количество секунд в результирующем значении.
- Преобразует значение типа «**Длительность**» в количество секунд.
- Принимает аргумент типа «**Число**», преобразует его в количество секунд и возвращает результирующее значение типа «**Длительность**».
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает логическое значение `True`, если год результирующей даты является високосным, в противном случае возвращает `False`.
...
Преобразует значение типа «**Дата и время**» в строку в формате ISO.
...
Преобразует значение типа «**Дата и время**» в часовой пояс `UTC+00:00` и возвращает в виде строки в формате ISO.
...
Результат: `2025-05-26T11:01:17.184083Z`.
...
Возвращает логическое значение `True`, если значение аргумента приходится на текущую дату. В противном случае возвращает результат `False`.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00`и возвращает логическое значение `True`, если результирующее значение приходится на текущую дату. В противном случае возвращает `False`.
...
Возвращает значение `True`, если заданная дата является выходным днём для часового пояса `UTC+00:00`. В противном случае возвращает результат `False`.
...
Возвращает значение `True`, если заданная дата является рабочим днём для часового пояса `UTC+00:00`. В противном случае возвращает `False`.
...
Сравниваиет два аргумента типа «**Дата и время**». Возвращает логическое значение `True`, если первый аргумент меньше второго, в противном случае возвращает `False`. Значения аргументов преобразуются в часовой пояс `UTC+00:00`.
...
Принимает аргумент типа «**Дата и время**» и возвращает числовое значение, соответствующее минуте указанной даты.
...
Принимает аргумент типа «**Дата и время**» и возвращает числовое значение, соответствующее минуте указанной даты для часового пояса `UTC+00:00`.
...
Принимает аргумент типа «**Дата и время**» и возвращает числовое значение, соответствующее месяцу указанной даты.
...
Принимает аргумент типа «**Дата и время**» и возвращает числовое значение, соответствующее месяцу указанной даты для часового пояса `UTC+00:00`.
...
Сравнивает два аргумента типа «**Дата и время**» . Если аргументы не равны, возвращает логическое значение `True`, в противном случае возврашает `False`. Значения аргументов преобразуются в часовой пояс `UTC+00:00`.
...
Преобразует строку в значение типа «**Дата и время**» в часовом поясе `UTC+00:00` согласно заданной макске.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает числовое значение, соответствующее секундам указанной даты.
...
Принимает аргумент типа «**Дата и время**» и возвращает дату и время начала дня, на который приходится значение аргумента.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает дату и время начала дня, на который приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**» и возвращает дату и время начала месяца, на который приходится значение аргумента.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает дату и время начала месяца, на который приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**» и возвращает дату и время начала квартала, на который приходится значение аргумента.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает дату и время начала квартала, на который приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**» и возвращает дату и время начала недели, в пределах которой находится значение аргумента для часового пояса `UTC+00:00`.
...
Принимает аргумент типа «**Дата и время**» и возвращает дату и время начала года, на который приходится значение аргумента.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает дату и время начала года, на который приходится результирующее значение.
...
Вычитает из значения аргумента типа «**Дата и время**» значение типа «**Длительность**». Возвращает значение типа «**Дата и время**» для часового пояса `UTC+00:00`.
...
Принимает аргумент типа «**Дата и время**» и возвращает номер недели года, на которую приходится значение аргумента.
...
Принимает аргумент типа «**Дата и время**», преобразует его в часовой пояс `UTC+00:00` и возвращает номер недели года, на которую приходится результирующее значение.
...
Возвращает продолжительность между двумя датами для часового пояса `UTC+00:00` с учётом выходных дней.
...
``` sql
WORKDAYSDURATIONUTC(DATE('2025-05-01-12:00'), DATE('2025-05-12+00:00'))
```
...
<td markdown="block">
Прибавляет к указанной дате количество рабочих дней с учётом выходных дней для часового пояса `UTC+00:00` и возвращает получившуюся дату.
...
Принимает аргумент типа «**Дата и время**» и возвращает числовое значение, соответствующее году указанной даты для часового пояса `UTC+00:00`.
