...
Принимает два логических значения или выражения, возвращающих логические значения, и возвращает результат логического умножения (конъюнкции) этих значений.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает числовое значение, соответствующее веку указанной даты.
...
Приводит значение типа «**Дата и время**» в заданный часовой пояс в формате IANA.
...
Принимает аргумент типа «**Дата и время**» и часовой пояс в формате IANA. Возвращает число месяца указанной даты.
...
- `dateTime`: дата и время.
- `timeZone`: строка, часовой пояс в формате IANA (необязательный аргумент).
...
Принимает аргумент типа «**Дата и время**» переводит его в часовой пояс `UTC+00:00` и возвращает название дня недели указанной даты.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает число, соответствующее дню года результирующей даты.
...
Принимает аргумент типа «**Дата и время**» или два аргумента типа «**Число**» — год и месяц. Возвращает количество дней в месяце указанной даты.
...
Принимает аргумент типа «**Дата и время**» или два аргумента типа «**Число**» — год и месяц. Преобразует дату и время в часовой пояс `UTC+00:00`. Возвращает количество дней в месяце указанной даты.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает число месяца указанной даты.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает дату и время окончания дня, на который приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает дату и время окончания месяца, на который приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает дату и время окончания квартала, на который приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает дату и время окончания недели, на которую приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает дату и время окончания года, на который приходится результирующее значение.
...
Сравнивает значения двух аргументов и возвращает `True`, если они равны, в противном случае возвращает `False`.
...
Преобразует аргумент типа «**Длительность**» в количество часов.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает числовое значение, соответствующее часу результирующей даты.
...
- Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает количество секунд в результирующем значении.
...
<td markdown="block">
Определяет список. Принимает перечисление значений, разделяет их запятыми и возвращает список.
...
<td markdown="block">
Принимает два значения логического типа или два выражения, результатом которых являются значения логического типа, и возвращает результат логического сложения этих значений.
...
<td markdown="block">
Принимает в качестве аргументов два значения числового типа и возвращает результат умножения одного на другое.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает числовое значение, соответствующее секундам указанной даты.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает дату и время начала дня, на который приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает дату и время начала месяца, на который приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает дату и время начала квартала, на который приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает дату и время начала года, на который приходится результирующее значение.
...
Принимает аргумент типа «**Дата и время**», переводит его в часовой пояс `UTC+00:00` и возвращает номер недели года, на которую приходится результирующее значение.
