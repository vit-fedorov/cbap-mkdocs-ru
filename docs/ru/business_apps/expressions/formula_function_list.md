...
Прибавляет указанное количество дней к значению типа «**Дата и время**» с указанием часового пояса в формате UTC.
...
Прибавляет указанное количество часов к значению типа «**Дата и время**» с указанием часового пояса в формате UTC.
...
Прибавляет указанное количество минут к значению типа «**Дата и время**» с указанием часового пояса в формате UTC.
...
``` sql
ADDMINUTESUTC(DATE('2024-01-01T01:01:01+03:00'), 3)
```

Результат: `01.01.2024 4:04:01`.
...
Прибавляет указанное количество месяцев к значению типа «**Дата и время**» с указанием часового пояса в формате UTC.
...
``` sql
ADDMONTHSUTC(DATE('2024-01-01T01:01:01+03:00'), 3)
```

Результат: `01.04.2024 4:01:01`
...
Прибавляет указанное количество секунд к значению типа «**Дата и время**» с указанием часового пояса в формате UTC.
...
``` sql
ADDSECONDSUTC(DATE('2024-01-01T01:01:01+03:00'), 3)
```

Результат: `01.01.2024 4:01:04`.
...
Прибавляет значение типа «**Длительность**» к значению типа «**Дата и время**» с указанием часового пояса в формате UTC.
...
``` sql
ADDUTC(DATE('2024-01-01T01:01:01+03:00'), DURATION('P1DT12H30M5S'))
```

Результат: `02.01.2024 16:31:06`.
...
<td markdown="block">
Прибавляет указанное количество лет к значению типа «**Дата и время**» с указанием часового пояса в формате UTC.
...
``` sql
ADDYEARSUTC(DATE('2024-01-01T01:01:01+03:00'), 3)
```

Результат: `01.01.2027 4:01:01`
...
Проверяет факт вхождения даты или длительности в заданный диапазон. Значения типа «**Дата и время**» должны быть указаны с часовым поясом в формате UTC.
...
``` sql
CONVERTTIMEZONE(DATE("2025-05-05T13:45:15+03:00"), "Europe/London")
```

Результат: `05.05.2025 11:45:15`.
...
<td markdown="block">
Принимает аргумент типа «**Дата и время**» и возвращает числовое значение, соответствующее дню месяца указанной даты.
...
``` sql
SUBUTC(DATE('2025-01-01T01:01:01+03:00'), DURATION('P1DT1H30M0S'))
```

Результат: `31.12.2024 2:31:01`.
