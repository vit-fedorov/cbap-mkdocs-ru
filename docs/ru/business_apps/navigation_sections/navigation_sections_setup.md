...
_![Панель и разделы навигации](img/navigation_panel.png)_

## Просмотр списка разделов навигации и настройка раздела {: #navigation_section_setup_view}

1. На странице «**[Администрирование][apps]**» приложения выберите пункт «**Разделы навигации**» <i class="fa-light fa-keynote"></i>.
...
8. Добавьте элементы в раздел навигации, перетащив их из панели элементов на макет. См. _[«Использование конструктора раздела навигации»](#navigation_section_setup_designer)_
...
## Использование конструктора раздела навигации {: #navigation_section_setup_designer .pageBreakBefore }
...
## Назначение раздела навигации ролям {: .pageBreakBefore }
...
3. Нажмите ссылку с количеством ролей.
    ...
    _![Переход к настройке ролей для раздела навигации](navigation_sections_setup_roles_setting.png)_
...
7. Нажмите кнопку «**Применить**».
    ...
    _![Выбор ролей для раздела навигации](navigation_sections_setup_select_roles_window.png)_

## Клонирование раздела навигации {: #navigation_section_setup_clone .pageBreakBefore }
...
## Удаление элементов из раздела навигации {: #navigation_section_setup_delete .pageBreakBefore }
