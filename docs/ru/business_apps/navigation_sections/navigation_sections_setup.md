...
_![Панель навигации](navigation_panel.png)_

Внешний вид и состав панели навигации настраиваются:

* на уровне приложений при их разработке — см. «**[Настройка разделов навигации][navigation_sections_setup]**», «**[Настройка рабочего стола][desktop_setup]**», «**[Настройка страниц][pages_setup]**»;
* на уровне аккаунтов при использовании приложений конечными пользователями — см. «**[Использование системы. Панель навигации][navigation_panel]**» и «**[Использование системы. Панель навигации. Рабочий стол][desktop]**».
...
## Просмотр списка разделов навигации и настройка раздела {: #navigation_section_setup_view}

1. В разделе «**[Администрирование][администрирование-приложения]**» приложения выберите пункт «**Разделы навигации**» <i class="fa-light fa-keynote"></i>.
2. Отобразится список разделов навигации для текущего [приложения][apps].

_![Список разделов навигации](navigation_sections_list.png)_
...
8. Добавьте элементы в раздел навигации, перетащив их из панели элементов на макет.
...
## Использование конструктора раздела навигации {: #navigation_section_setup_designer}
...
1. **Вкладки**
    ...
    - **Страница в составе рабочего стола** — на этой вкладке настраивается страница, которую можно включить в состав рабочего стола. См. «**[Настройка рабочего стола][desktop_setup]**» и «**[Настройка страниц][pages_setup]**».
2. **Кнопки**
    ...
    - **Очистить** — [удаление всех пунктов][navigation_section_setup_delete] из раздела навигации.
...
_![Конструктор раздела навигации](navigation_section_designer.png)_

## Удаление элементов из раздела навигации {: #navigation_section_setup_delete}
...
_![Удаление элемента путем перетаскивания из макета раздела навигации](navigation_sections_setup_delete_element.png)_

## Назначение раздела навигации ролям

Для каждой роли в приложении можно назначить один раздел навигации. При этом аккаунту может быть назначено несколько ролей, и тогда пользователю этого аккаунта будет доступно несколько разделов навигации.

_![Кнопка выбора и список разделов навигации, доступных пользователю](navigation_sections_setup_assign_roles.png)_
...
_![Настройка ролей в конструкторе раздела навигации](navigation_sections_setup_roles_setting.png)_
...
6. Чтобы перенести сразу все роли, нажмите кнопку «**Выбрать все**» <i class=" fal  fa-check-double " aria-hidden="true"></i>.
7. Нажмите кнопку «**Применить**».

_![Окно выбора списка ролей](navigation_sections_setup_select_roles_window.png)_

## Клонирование раздела навигации {: #navigation_section_setup_clone}
...
4. Отобразится [конструктор созданного раздела навигации][navigation_section_setup_designer].
