---
title: Информационные страницы. Настройка
kbId: 2214
tags:
    - страница
...
# Информационные страницы. Настройка. Баннеры, витрины, временные шкалы, диаграммы, плитки, показатели, списки, шаги {: #pages_setup}
...
2. Создайте или откройте страницу для редактирования:
    ...
    _![Создание информационной страницы](pages_setup_add.png)_
...
6. Чтобы удалить элементы со страницы, перетащите их за пределы макета или нажмите кнопку «Очистить» и подтвердите удаление. Сохраните страницу.
    ...
    _![Добавление элемента на страницу](pages_setup_edit.png)_
