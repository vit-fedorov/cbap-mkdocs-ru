...
<!-- дописать концептуально логику построения сценариев. administration/connections_communication_routes/connections/ -->
<div class="admonition question" markdown="block">
## Определения {: .admonition-title #definitions}

**Сценарий** — это алгоритм валидации и обработки данных.

Сценарий запускается при срабатывании указанного [события][scenario_event_actions] и выполняет определённую последовательность [действий][scenario_event_actions].

Для сценариев предусмотрены следующие **[типы событий][scenario_event_actions]**:
...
Существует несколько **[типов действий][scenario_event_actions]**, которые применяются в сценарии:
