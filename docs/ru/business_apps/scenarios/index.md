...
Сценарии являются инструментом автоматизации в приложениях и имеют ряд особенностей:
...
- Чтобы отследить ошибки в сценариях, можно воспользоваться действием «Проверить результат выражения». _См. подробнее [«Отладка формул, выражений N3, сценариев и C#-скриптов»][expression_debug]_.
