...
**Сценарий** представляет собой алгоритм обработки и передачи данных, который запускается при наступлении заданного [события][scenario_event] и выполняет настроенную последовательность [действий][scenario_actions]. 
