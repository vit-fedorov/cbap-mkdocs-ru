...
**Сценарий** представляет собой алгоритм для валидации и обработки данных, который запускается при наступлении [события][scenario_event_actions]. Сценарий выполняет заранее заданную последовательность [действий][scenario_event_actions].
...
Сценарии имеют особенности использования:
