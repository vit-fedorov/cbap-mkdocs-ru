...
## Настройка области кнопок {: #button_area_configure}
...
1. Чтобы настроить свойства области кнопок выберите её на форме или таблице.
    ...
    !!! note "Примечание"
        ...
        - _В каждой [области][form_static_elements]#form_static_elements_area) формы и на каждой [вкладке][form_static_elements]#form_static_elements_tabs)_ предусмотрена пустая область кнопок, в которую можно поместить кнопки из текущего шаблона.
