...
1. Чтобы настроить свойства области кнопок выберите её на форме или таблице.
    ...
    !!! note "Примечание"
        ...
        - _В каждой [области]({{ kbArticleURLPrefix }}2530#formset5) формы и на каждой [вкладке]({{ kbArticleURLPrefix }}2530#formset4)_ предусмотрена пустая область кнопок, в которую можно поместить кнопки из текущего шаблона.
