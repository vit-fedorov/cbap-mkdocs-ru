...
!!! Question "Определения"
    ...
    * Шаблоны экспорта можно создавать для [шаблонов записей][record_templates], [шаблонов аккаунтов][account_templates], [шаблонов оргединиц](organizational_unit_templates.md) и [шаблонов ролей][role_templates].    
