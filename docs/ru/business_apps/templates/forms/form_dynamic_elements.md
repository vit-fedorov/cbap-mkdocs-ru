...
kbTitle: 'Динамические элементы формы: поля атрибутов и вложенные формы. Настройка представления'
tags:
    - поля на форме
    - атрибуты на форме
    - вложенная форма
...
# Динамические элементы формы. Настройка представления {: #form_dynamic_elements}
...
## Настройка полей атрибутов {: .pageBreakBefore }
...
4. Настройте [общие свойства](#общие-свойства-полей) и представление поля в соответствии с его типом:
    ...
    - [Дата и время](#form_dynamic_elements_date_time)
...
### Общие свойства полей {: .pageBreakBefore }
...
### Аккаунт {: #form_dynamic_elements_account .pageBreakBefore }
...
### Гиперссылка {: #form_dynamic_elements_hyperlink .pageBreakBefore }
...
### Дата и время {: #form_dynamic_elements_date_time .pageBreakBefore }

Представление поля атрибута типа «**Дата и время**» на форме определяется свойствами поля, **форматом отображения**, заданным в свойствах атрибута, и настройкам часового пояса.

Помимо [общих свойств](#общие-свойства-полей) у этого поля предусмотрено следующее свойство:

- **Часовой пояс** — выберите атрибут типа «**Часовой пояс**», который будет применяться при отображении значения в данном поле.
...
### Изображение {: #form_dynamic_elements_image .pageBreakBefore }
...
#### Добавление на форму атрибутов связанного шаблона записи {: .pageBreakBefore }
...
1. В панели элементов конструктора формы разверните атрибут типа «**Запись**», нажав стрелку вниз <i class="fa-light fa-angle-down">‌</i> справа от названия атрибута.
2. Отобразится список атрибутов шаблона аккаунта, связанного с атрибутом.
3. Перетащите на макет формы или в таблицу требуемый атрибут аккаунта.
4. Настройте поле или столбец атрибута с помощью панели «**Свойства поля**» или «**Свойства столбца таблицы**».
...
#### Настройка раскрывающегося списка {: .pageBreakBefore #form_dynamic_elements_dropdown }
...
В раскрывающийся список выводятся первые 50 записей, отсортированных по алфавиту. Если записей больше 50, то отобразится предупреждение — _«Отображены не все значения, уточните поиск»_. Для уточнения поиска можно использовать **расширенный фильтр**.

!!! question "Расширенный фильтр для раскрывающегося списка"
    ...
    **Порядок настройки фильтра для раскрывающегося списка**
    ...
    5. Чтобы применить настроенный фильтр, нажмите кнопку «**Найти**».
    6. Чтобы отменить фильтрацию, нажмите кнопку «**Сбросить фильтры**».
...
#### Настройка таблицы {: #form_dynamic_elements_table .pageBreakBefore }
...
##### Пример настройки древовидной таблицы с иерархической нумерацией {: .pageBreakBefore }
...
2. В шаблоне «Работы» создайте следующие атрибуты:
    ...
    |---|---|---|
    |_Дочерние работы_|**Запись**|<ul><li>**Связанный шаблон:** _Работы_</li><li>**Формат отображения:** **гиперссылка**</li><li>**Хранить несколько значений:** флажок установлен</li><li>**Взаимная связь с атрибутом:** **с новым**</li><li>**Свойства нового атрибута**<ul><li>**Название:** _Родительская работа_</li><li>**Хранить несколько значений:** флажок снят</li></ul></li></ul>|
...
8. Выберите область кнопок таблицы _«Дочерние работы»_ и добавьте на неё кнопки «<i class=" fal  fa-plus ">‌</i> **Создать**», «<i class=" fal  fa-plus-square ">‌</i> **Добавить**», «<i class=" fal  fa-times ">‌</i> **Исключить**».
9. Сохраните форму.
...
12. Протестируйте работу древовидной таблицы:
    ...
    - Переместите любую работу между уровнями иерархии:
        ...
        - нажмите кнопку <i class="fa-light fa-arrow-alt-from-left ">‌</i>, чтобы переместить работу на один уровень иерархии вниз;
        - нажмите кнопку <i class="fa-light fa-arrow-alt-from-right">‌</i>, чтобы переместить работу на один уровень иерархии вверх.
...
#### Настройка шевронов {: #form_dynamic_elements_chevron .pageBreakBefore }
...
#### Настройка диаграммы Ганта {: .pageBreakBefore }
...
Подробные сведения см. в статьях _«[Диаграмма Ганта. Настройка][gantt_chart_create]»_ и _«[Диаграмма Ганта. Использование][gantt_chart_use]»_.

_![Поле атрибута типа «Запись»: диаграмма Ганта и таблица исходных записей для диаграммы](gantt_chart_example2.png)_

#### Настройка карты {: #form_dynamic_elements_map .pageBreakBefore }
...
2. При необходимости настройте быстрые ответы, см. _«[Настройка быстрых ответов][discussion_configure_quick_answers]»_.
...
### Организационная единица {: .pageBreakBefore }
...
#### Добавление на форму атрибутов шаблона оргединицы {: .pageBreakBefore }
...
1. В панели элементов конструктора формы разверните атрибут типа «**Организационная единица**», нажав стрелку вниз <i class="fa-light fa-angle-down">‌</i> справа от названия атрибута.
2. Отобразится список атрибутов шаблона аккаунта, связанного с атрибутом.
3. Перетащите на макет формы или в таблицу требуемый атрибут аккаунта.
4. Настройте поле или столбец атрибута с помощью панели «**Свойства поля**» или «**Свойства столбца таблицы**».
...
### Связанные процессы {: #form_dynamic_elements_linked_processes .pageBreakBefore }
...
### Список значений {: .pageBreakBefore }
...
#### Настройка представления {: .pageBreakBefore }
...
#### Добавление на форму атрибутов шаблона роли {: .pageBreakBefore }
...
### Цвет {: #form_dynamic_elements_color .pageBreakBefore }
...
#### Пример использования {: #form_dynamic_elements_color_diagram_example .pageBreakBefore }
...
### Чертёж {: #form_dynamic_elements_drawing .pageBreakBefore }
...
Подробные сведения см. в статьях _«[Чертёж. Подготовка и импорт файла DWG][attribute_drawing_file_import]»_ и _«[Чертёж. Настройка][attribute_drawing]»_.
...
## Настройка вложенной формы {: #form_dynamic_elements_embedded_form .pageBreakBefore }
