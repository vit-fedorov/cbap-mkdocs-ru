...
Также предусмотрены элементы «**Группа кнопок**» и «**Разделитель кнопок**» для настройки на форме [области кнопок][button_area_configure].

</div>

## Область {: #form_static_elements_area}

**Область** представляет собой группу эле ментов формы с заголовком.
...
При добавлении вкладок на рабочую область конструктора форм, вкладки создаются с вложенным элементом «**Колонки**», который при необходимости можно удалить.
...
С помощью панели «**Свойства элементв «Вкладки**» можно добавлять новые вкладки, менять их порядок и удалять.
