...
Каждая вкладка имеет собственное системное имя, и, следовательно, для каждой вкладки (как и для элемента в целом) можно настроить отдельное [правило][form_rules] отображения.
