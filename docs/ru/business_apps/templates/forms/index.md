...
3. Отобразится список форм шаблона.
    ...
    !!! note "Примечание"
        ...
        - Список форм предусмотрен у шаблонов [записей](record_templates.md), [аккаунтов][account_templates], [ролей][role_templates] и [организационных единиц](organizational_unit_templates.md).
