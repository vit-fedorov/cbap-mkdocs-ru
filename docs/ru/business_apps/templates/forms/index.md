...
1. Выберите **[простое начальное событие](none_start_event.md)** или **[пользовательскую задачу][user_task]** в [конструкторе диаграммы][process_diagram_designer].
...
Подробнее о настройке типов формы см. статью _[«Ограничение доступа к формам»][form_access_control]_.
