...
- Инструкции по использованию форм для пользователей см. в статье _«[Формы. Использование][form_personal_use]»_.
...
### Операции на панели элементов конструктора форм {: #form_designer_elements_operations pageBreakBefore }
