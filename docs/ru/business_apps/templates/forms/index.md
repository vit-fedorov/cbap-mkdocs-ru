...
3. Настройте свойства формы:
    ...
    - **Тип**:
        ...
        - **Форма поиска** — выберите этот тип, чтобы настроить расширенную фильтрацию записей.

        Подробные сведения о выборе типа формы см. в статье _«[Публичные и внутренние формы. Контроль доступа][form_access_control]»_ и _«[Расширенная фильтрация. Настройка форм поиска][search_forms]»_.
