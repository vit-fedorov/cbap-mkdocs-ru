...
4. Настройте параметры импорта данных.
    ...
    - **Сопоставление данных** — настройте соответствие столбцов импортируемого файла атрибутам шаблона.
        ...
        - **Формат** — выберите формат импортируемой ячейки в соответствии с типом атрибута. См. [требования к импортируемому файлу](#подготовка-импортируемого-файла).
            ...
            - Для атрибута типа «**Запись**», «**Роль**» или «**Организационная единица**» выберите атрибут связанного шаблона **ID** или атрибут **Name** — это [атрибут-заголовок записей](displayed_attribute.md) связанного шаблона. Выбранный атрибут будет использоваться в качестве ключевого для привязки импортированных записей к связанному шаблону.
...
_![Настройка импорта данных из файла CSV](import_settings.png)_
...
1. Создайте [аккаунты](accounts.md) с перечисленными ниже **Ф. И. О.**: _Иванов И. И., Кулагина А. Н., Филиппов К. В., Журавлёва Т. С., Игнатьев А. Б._ Остальные свойства аккаунтов заполните произвольными сведениями.
...
5. Нажмите кнопку «**Загрузить**».
    ...
    _![Настройка импорта данных в шаблон «Заявления на отпуск»](import_settings_to_vacations.png)_
...
8. Заявление № 1 должно быть обновлено и должны появиться три новых заявления в соответствии с импортированными данными.
    ...
      _![Импортированные заявления на отпуск](import_added_records_to_vacation.png)_
...
17. Отобразится два решения, каждое по двум заявлениям на отпуск.  
    ...
    _![Импортированные решения по заявлениям на отпуск](import_settings_to_decisions.png)_
...
**[Аккаунты. Создание, настройка, замещение, привязка к шаблону аккаунта, назначение лицензий, удаление](accounts.md)**
