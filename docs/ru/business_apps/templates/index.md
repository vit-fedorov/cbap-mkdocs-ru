...
!!! question "Определения"
    ...
    **Шаблоны** служат для описания, хранения и обработки данных бизнес-сущностей и процессов.
    ...
    Для каждого [приложения][разработка-приложений] предусмотрен отдельный набор шаблонов. См. _«[Просмотр списка шаблонов приложения](#просмотр-списка-шаблонов-приложения)»._
    ...
    - [общие свойства шаблона](template_types/template_common_properties.md);
    - [таблицы](https://kb.comindware.ru/category.php?id=480) для отображения данных;
    - [карточки](cards_assign_to_table.md);
    - [формы](forms/index.md) для просмотра и ввода данных;
    - [кнопки](buttons/index.md) для выполнения операций в приложении;
    ...
    - [атрибуты](attributes/index.md) бизнес-сущности;
    - записи с экземплярами бизнес-сущностей;
    - [шаблоны экспорта](export_templates/index.md) данных в форматах DOCX, XLSX и PDF.

    Шаблон **процесса** содержит:

    - [диаграмму бизнес-процесса][диаграмма-процесса];
...
2. Отобразится список всех шаблонов в составе всех [приложений][разработка-приложений].
...
Шаблоны можно переносить между [приложениями][разработка-приложений] для рефакторинга или формирования связи между несколькими приложениями.
...
1. Нажмите кнопку «**Сменить приложение**» в разделе «**Основные свойства**» на вкладке «**[Свойства](template_types/template_common_properties.md)**» шаблона.
...
**[Атрибуты](attributes/attribute_types/index.md)**

**[Формы](forms/index.md)**

**[Кнопки](buttons/index.md)**

**[Шаблоны экспорта](export_templates/index.md)**
