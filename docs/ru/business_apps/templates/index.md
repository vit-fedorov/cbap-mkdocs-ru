...
Для каждого [приложения][apps] предусмотрен отдельный набор шаблонов. См. _«[Просмотр списка шаблонов приложения](#templates_view_in_app)»._
...
- **[шаблоны моделей][model_templates]** — для хранения элементов процессной архитектуры Архитекта
...
## Просмотр списка шаблонов приложения {: #templates_view_in_app }
...
[Шаблон роли][role_templates], [шаблон моделей][model_templates] и [шаблон организационной единицы][organizational_unit_templates] создаются автоматически при создании приложения.
...
## Просмотр всех записей (экземпляров) шаблона {: #templates_view_records .pageBreakBefore }
