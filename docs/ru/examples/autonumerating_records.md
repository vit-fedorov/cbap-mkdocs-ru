...
kbTitle: 'Автонумерация записей с помощью формулы, C#-скрипта или выражения N3'
tags:
    - C#
    - скрипт
    - C#-скрипт
...
С шаблоном _«Заявки»_ связан шаблон процесса _«Оформление заявки»_.

Необходимо настроить автоматическую нумерацию заявок, создаваемых при запуске процесса _«Оформление заявки»_.
