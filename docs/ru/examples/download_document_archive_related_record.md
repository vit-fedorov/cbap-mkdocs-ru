---
kbTitle: Атрибут «Документ». Скачивание архива файлов из связанных записей и его прикрепление к атрибуту
title: Атрибут «Документ». Получение архива файлов из связанных записей
tags:
    - C#
    - C#-скрипт
    - скрипт
...
# Атрибут «Документ». Получение архива файлов из связанных записей {: #example_csharp_document_download_archive_related_records }
...
1. Создайте **шаблон записи** _«Реестр документов»_ со следующим **атрибутом**:
    ...
    - **Тип данных: документ**
    - **Использовать для поиска записей:** флажок установлен</li><li>
    - **Хранить несколько значений:** флажок установлен</li
...
- _[Атрибут типа «Документ». Скачивание архива с файлами из таблицы и записи][example_csharp_document_download_archive]_
