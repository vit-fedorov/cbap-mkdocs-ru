...
Имеется шаблон _«Заявки»_, с которым связан шаблон _«Заявки на перевозку»_. В шаблоне _«Заявки на перевозку»_ имеется атрибут _«Статус»_ типа «**Список значений**».
...
- В шаблоне _«Заявки»_ имеется атрибут _«Заявки на перевозку»_:
    - **Тип данных: Запись**
...
1. Откройте для редактирования форму шаблона _«Заявки»_.
2. Поместите на форму атрибут _«Заявки на перевозку»_.
3. Настройте **свойства поля** _«Заявки на перевозку»_:
    ...
    - **Фильтр — Отображаемые записи: N3**
        ...
        {
            # Находим атрибут «Заявки на перевозку» в шаблоне «Заявки».
            ("Заявки" "Заявкинаперевозку") object:findProperty ?TransportRequestsAttribute.
...
1. Создайте несколько записей в шаблоне _«Заявки на перевозку»_, выбрав разные _типы ТС_, включая _легковой автомобиль_.
2. Создайте запись в шаблоне _«Заявки»_.
