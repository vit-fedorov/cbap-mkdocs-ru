...
# Настройка интерфейса приложения на разных языках {: multilingual_app }
...
!!! warning "Логика работы многоязычного интерфейса"
    ...
    - Для переключения языка отображения форм и навигации мы используем:
        ...
        - специальные группы и роли для пользователей, использующих приложение на на английском и русском языках;
...
8. Добавьте в этот раздел навигации шаблон записи _«Заявки / Requests»_ смените название пункта на _«Заявки»_.
9. Создайте раздел навигации _«Fleet management»_ и назначьте его роли _«Пользователь EN»_.
10. Добавьте в этот раздел навигации шаблон записи _«Заявки / Requests»_ и смените название пункта на _«Requests»_.
