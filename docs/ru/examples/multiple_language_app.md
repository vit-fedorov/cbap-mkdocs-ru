...
Здесь представлена инструкция по настройке шаблонов записи на русском и английском языках, а также описан процесс добавления кнопки для изменения языка интерфейса.
