...
Здесь представлена инструкция по настройке шаблонов записи на русском и английском языках, а также кнопки для смены языка интерфейса.
...
4. Создайте новую форму _«Форма на русском»_ и поместите на неё атрибуты.
5. Отредактируйте названия полей атрибутов так, чтобы они отображались только на русском.
6. Сохраните форму.
7. Создайте новую форму _«Форма на английском»_ и поместите на неё атрибуты.
