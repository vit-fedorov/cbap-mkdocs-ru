...
**{{ productName }}** может отображать интерфейс на различных языках. Для этого можно задать названия шаблонов и атрибутов на нескольких языках, настроить отображение форм в зависимости от языка пользователя, а также реализовать переключение между языками.

Здесь представлена инструкция по настройке шаблонов записи на русском и английском языках, настройке мультиязычной ролевой модели, описан процесс добавления кнопки для изменения языка интерфейса, а также приведены примеры использования скриптов и формул для автоматизации.

## Прикладная задача

Требуется настроить шаблоны _«Заявки»_ и _«Тип автомобиля»_ и форму для них на двух языках. Интерфейс пользователя должен быть на одном определённом языке.
...
!!! tip "Название атрибута на разных языках"
    ...
    Чтобы создавать одинаковые формы на разных языках и унифицировать названия шаблонов и атрибутов, рекомендуется задавать название на требуемых языках через `/`.
...
5. Измените названия полей атрибутов так, чтобы они отображались только на русском.
6. Сохраните форму.
7. Создайте новую форму _«Форма на английском»_ и добавьте на неё атрибуты.
8. Измените названия полей атрибутов так, чтобы они отображались только на английском.
9. Сохраните форму.
...
7. На вкладке «**Скрипт**» добавьте C#-скрипт по следующему образцу:
...
8. На вкладке «**Условия отображения**» добавьте формулу:
...
9. Сохраните кнопку.
10. Добавьте обе кнопки на форму шаблона _«Пользователи»_.
11. Добавьте пользователей в экземпляры записи шаблона _«Пользователи»_.
...
3. Перейдите к шаблону _«Пользователи»_ и дважды нажмите строку с данными выбранного пользователя.
