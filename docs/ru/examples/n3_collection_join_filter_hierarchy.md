---
title: 'Объединение и фильтрация иерархических коллекций с помощью N3'
kbId: 5108
tags:
  - запись
  - коллекция
...
# Объединение и фильтрация иерархических коллекций с помощью N3 {: #example_n3_collection_join_filter_hierarchy }
