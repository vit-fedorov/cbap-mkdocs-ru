...
Выражение N3 не позволяет напрямую изменять значения атрибутов, однако с его помощью можно создать **переменную сценария** и поместить в неё необходимые данные для дальнейшего использования.
