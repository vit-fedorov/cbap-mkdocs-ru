...
Здесь представлена инструкция по настройке кнопки для копирования данных из справочника в шаблон записи с использованием C#-скрипта и локальной переменной.
...
## Настройка кнопки для передачи данных
...
8. На вкладке «**Скрипт**» вставьте следующий код:
