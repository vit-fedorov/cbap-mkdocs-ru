...
kbTitle: Локальная переменная в C#-скрипте и сценарии. Использование для копирования данных между шаблонами
tags:
    - C#
    - скрипт
    - C#-скрипт
...
# Локальная переменная в C#-скрипте и сценарии. Копирование данных
