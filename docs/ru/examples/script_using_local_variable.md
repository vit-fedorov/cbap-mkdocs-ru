...
# Копирование данных между шаблонами с помощью C#-скрипта и локальной переменной по нажатию кнопки
...
10. Сохраните кнопку.
11. Нажмите гиперссылку «**Настроить диалоговое окно**».
12. Вынесите локальную переменную _«Конкурс»_ на форму и сохраните.
13. Вынесите кнопку _«Добавить позиции в конкурс»_ на форму таблицы записей шаблона _«Номенклатура продукции»_.
14. На вкладке «**Скрипт**» вставьте следующий код:
