...
- **[Версия 4.7.3084][release_notes_4.7.3084] / 02.11.2024**: улучшена работа списков экземпляров шаблонов, глобальной конфигурации и работа, оптимизирована работа проверки значений атрибутов.
