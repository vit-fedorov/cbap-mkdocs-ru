...
- **[Версия 4.7.3084][release_notes_4.7.3084] / 02.11.2024**: улучшены настройки таблицы и работа глобальной конфигурации, оптимизирована работа атрибутов и ролей, повышена общая стабильность и функциональность продукта.
