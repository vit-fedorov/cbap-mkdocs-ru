...
# Сведения о выпуске 4.7.2632 {: #release_notes_4.7.2632}

## Введение

В **{{ productName }}** версии 4.7.2632 были реализованы реализованы перечисленные ниже новые возможности, улучшения и исправления.
