...
На этом уроке вы создадите реестр данных (**шаблон записи**) для заявок на автомобиль, настроите атрибуты, их отображение в виде таблицы и экранной формы, а затем создадите несколько заявок от имени _Заказчика_.
