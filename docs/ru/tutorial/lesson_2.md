...
Следуя указаниям в этом уроке, вы создадите реестр данных (**шаблон записи**) для заявок на автомобиль, настроите атрибуты, их отображение в виде таблицы и экранной формы, а затем создадите несколько заявок от имени _Заказчика_.
...
6. В поле «**Название**» введите наглядное наименование шаблона — _«Заявки на автомобиль»_.
...
1. На странице шаблона записи _«Заявки на автомобиль»_ выберите вкладку «**Формы**».
    ...
    !!! note "Основная форма шаблона"
        ...
        Для шаблона записи _«Заявки на автомобиль»_ была создана форма _«Заявки на автомобиль — Основная форма»_.

2. В списке форм дважды нажмите пункт _«Заявки на автомобиль — Основная форма»_.
...
5. Введите **название** _«Одобрено»_ и выберите **тип данных** «**Логический**».
