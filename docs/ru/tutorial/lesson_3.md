...
22. Между начальным событием и задачей _«Рассмотреть заявку»_ добавьте элемент «**Развилка** «**и**» и назовите его _«Рассмотрение заявки»_.
...
26. Добавьте элемент «**Развилка** «**и**» от развилки _«Есть машина?»_.
    ...
    !!! question "Развилка «и»"
        ...
        **Развилка «и»** (параллельная) используется для:
            - разделения процесса на несколько потоков, которые будут выполняться одновременно;
