...
- Пройден [Урок 2. Мой первый реестр данных][lesson_2]:
    - создан реестр данных (**шаблон записи**) *«Заявки на автомобиль»*;
...
6. В поле «**Связанный шаблон**» выберите шаблон *«Заявки на автомобиль».*
...
4. Перетащите с панели элементов форму *«Заявки на автомобиль — Основная форма»* на макет формы. Нажмите кнопку «**Сохранить**». Вернитесь к диаграмме процесса, нажав кнопку «**Назад**» в браузере.
...
8. Разверните элемент *«Заявки на автомобиль»* на панели элементов слева и перетащите форму *«Заявки на автомобиль — Основная форма»* на макет формы.
...
2. Перетащите форму *«Заявки на автомобиль — Основная форма»*на макет формы.
...
4. Нажмите кнопку «**Добавить атрибут**» *‌* рядом с пунктом *«Заявки на автомобиль».*
...
3. На левой панели разверните элемент *«Заявки на автомобиль»* и перетащите форму *«Заявки на автомобиль — Основная форма»* под область *«Вам отказано».*
...
6. Аналогичным образом настройте форму для задачи *«Машина выделена»* — добавьте на форму область *«Машина выделена»* и дочернюю форму *«Заявки на автомобиль — Основная форма»*. Установите для дочерней формы режим **доступа** «**Только для чтения**». Сохраните форму и вернитесь к диаграмме процесса.

    _![Настройка формы задачи «Машина выделена»](https://kb.comindware.ru/assets/img_6242eda939124.png)_

7. Настройте форму для задачи *«Выполнить рейс»* — добавьте на форму область *«Выполнить рейс»* и  и дочернюю форму *«Заявки на автомобиль — Основная форма»*. Установите для дочерней формы режим **доступа** «**Только для чтения**». Сохраните форму и вернитесь к диаграмме процесса.
