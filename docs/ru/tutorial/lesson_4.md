...
- Пройден [Урок 3. Мой первый бизнес-процесс][lesson_3]:
...
4. Выберите задачу *«Отменить поездку»* на схеме процесса. Справа отобразится информация о её выполнении.
...
5. Перейдите на вкладку «**Журнал изменений**» и разверните задачу *«Рассмотреть заявку»* для просмотра информации о ней.

    _![Вкладка «Журнал изменений» для экземпляра процесса](https://kb.comindware.ru/assets/img_6474ce0c70e7b.png)_

    Вкладка «**Журнал изменений**» для элемента процесса.

    Задача *«Рассмотреть заявку»* на диаграмме процесса теперь выделена желтым цветом.
...
3. Перейдите к странице «**Разделы навигации**».
    ...
    _![Администрирование бизнес-приложения — пункт «Разделы навигации»](https://kb.comindware.ru/assets/img_630e1ee90da9d.png)_
