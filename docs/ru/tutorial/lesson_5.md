...
**Предусловия:**пройден [Урок 2. Мой первый реестр данных][lesson_2], создан и настроен реестр данных *«Заявка на автомобиль»*.
...
6. Перетащите на диаграмму шаблон записи *«Заявка на автомобиль»* с левой панели.
...
6. Нажмите кнопку «**Настроить шаблон**» <em class="fa-light fa-gear">‌</em>.
