...
**Предусловия:**пройден [Урок 2. Мой первый реестр данных][lesson_2], создан и настроен реестр данных *«Заявки на автомобиль»*.
...
6. Перетащите на диаграмму шаблон записи *«Заявки на автомобиль»* с левой панели.
...
1. В модели данных заказа автотранспорта выберите шаблон *«Заявки на автомобиль»* и в меню элемента нажмите кнопку «**Добавить новый атрибут**» *‌*.
...
Нам понадобится атрибут, который свяжет реестры *«Автомобиль»* и *«Заявки на автомобиль»* связью вида 1:M (один к многим) — когда на один автомобиль может быть несколько заявок. Такую связь позволяет установить атрибут типа «**Запись**» с **взаимной связью и несколькими значениями**.
...
- выберите **связанный шаблон** *«Заявки на автомобиль»;*
...
Теперь свяжем реестр данных *«Заявки на автомобиль»* с *«Затратами»* с помощью взаимной связи атрибутов типа «**Запись**»…

1. Выберите шаблон *«Заявки на автомобиль»* и нажмите кнопку *‌* ( **Добавить новый атрибут**) в меню элемента.
...
2. Создайте атрибут со следующими свойствами:
    ...
    ![Создание атрибута «Затраты» типа «Запись» для шаблона «Заявки на автомобиль», взаимно связанного с шаблоном «Затраты»](https://kb.comindware.ru/assets/img_6310a11c1a8ce.png)

3. На диаграмме должна отображаться связь между шаблонами *«Заявки на автомобиль»* и *«Затраты»*. Если связь не отображается, в меню элемента нажмите кнопку «**Показать связанные элементы**».

    _![Отображение связей шаблона записи «Заявки на автомобиль»](https://kb.comindware.ru/assets/img_62435dabb2301.png)_
