...
Настроим форму для задачи _«Принять заявку»_, чтобы _Сотрудник гаража_ мог выбрать машину для выполнения рейса.
...
4. В меню элемента нажмите кнопку «**Форма**» <i class="fa-light fa-newspaper"></i>.
    ...
    _![Переход к настройке формы задачи «Принять заявку» на диаграмме процесса](https://kb.comindware.ru/assets/img_6311c2bd7100c.png)_
...
8. Сохраните форму.
    ...
    _![Добавление атрибута «Автомобиль» на форму задачи «Принять заявку»](https://kb.comindware.ru/assets/img_6243655bcc67c.png)_
...
2. Настройте **новый атрибут**:
    ...
    _![Создание числового атрибута в шаблоне «Заявки на автомобили»](https://kb.comindware.ru/assets/img_6311c609a66c7.png)_
...
Реализуем для _Водителем_ возможность ввода данных нового автомобиля перед выполнением рейса.
...
2. В форме задачи _«Выполнить рейс»_ нажмите кнопку «**Создать**» в поле _«Автомобиль»._
    ...
    _![Создание автомобиля с помощью раскрывающегося списка на форме](https://kb.comindware.ru/assets/img_6311ca66b0f71.png)_
...
В ходе этого урока вы настроили для _Сотрудника гаража_ форму задач и возможность выбора типа автомобиля, реализовали для _Водителя_ возможность добавления нового автомобиля перед выполнением рейса и протестировали усовершенствованный процесс.
