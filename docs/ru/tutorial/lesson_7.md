...
3. В меню элемента нажмите кнопку «**Форма**» <em class="fa-light fa-newspaper">‌</em>.
4. В конструкторе формы разверните элемент *«Заявка на автомобиль»* на панели элементов.
5. Нажмите кнопку «**Редактировать**» <em class="fa-light fa-pencil">‌</em> у атрибута *«Итоговая сумма затрат».*
6. В окне свойств атрибута установите флажок «**Вычислять по автоматически**».
7. В поле «**Вычисляемое выражение**» нажмите кнопку «**Открыть в редакторе**»  <em class="fa-light fa-pencil">‌</em>.
...
10.  В отобразившемся раскрывающемся списке дважды нажмите пункт `Затраты` со значком <em class="fa-light fa-list-alt">‌</em>.
...
15. В отобразившемся раскрывающемся списке дважды нажмите пункт `id`. в формулу будет вставлено системное имя `id` атрибута *«ID»* текущего шаблона *«Заявка на автомобиль».*
    ...
    _![Вставка в выражение системного имени атрибута «ID» шаблона «Заявка на автомобиль»](https://kb.comindware.ru/assets/img_6475c34222af8.png)_
...
15. Ведите формулу: `FORMAT("ЗA-{0}",LIST(COUNT(from b in db->Заявканаавтомобиль select b->id)))`. Нажмите кнопку с зеленым флажком.
    ...
    - `Заявканаавтомобиль` — это системное имя шаблона записи *«Заявка на автомобиль».*
...
3. В меню элемента нажмите кнопку «**Свойства**» <em class="fa-light fa-gear">‌</em>.
