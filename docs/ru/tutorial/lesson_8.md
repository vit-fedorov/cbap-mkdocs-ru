...
12. Раскройте список *«Заявка на автомобиль»* на панели элементов слева и перетащите список «**Все записи**» в таблицу разрешений.
13. Перетащите в таблицу разрешений форму *«Заявка на автомобиль — Основная форма».*
14. Установите разрешения «**Создание**» и «**Просмотр**» для шаблона записи *«Заявка на автомобиль».*
15. Установите разрешение «**Просмотр**» для основной формы и таблицы «**Все записи**» шаблона *«Заявка на автомобиль».*
