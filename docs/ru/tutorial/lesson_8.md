...
7. Выберите группу _«Сотрудники»_ и добавьте в неё аккаунт _Заказчика_.
...
8. Разверните пункты «**Шаблоны записей**» — _«Затраты»_.
9. Перетащите на макет раздела навигации таблицу «**Все записи**» и переименуйте её в _«Затраты»_.
10. Сохраните раздел навигации.
