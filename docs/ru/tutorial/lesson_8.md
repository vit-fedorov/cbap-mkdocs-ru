...
6. Нажмите кнопку «**Создать**», чтобы сохранить группу _«Сотрудники»_.
    ...
    _![Результирующий список групп](https://kb.comindware.ru/assets/img_631651524e957.png)_
...
7. В меню элемента нажмите кнопку «**Свойства**» <i class="fa-light fa-gear">‌</i>.
    ...
    _![Переход к настройке свойств задачи с диаграммы процесса](https://kb.comindware.ru/assets/img_631653d993314.png)_
...
8. Нажмите кнопку «**Создать**», чтобы сохранить аккаунт.
    ...
    _![Создание аккаунта Диспетчера](https://kb.comindware.ru/assets/img_6316553102f6d.png)_
...
11. Создайте аккаунт _Заказчика_ с любой должностью. Пользователь этого аккаунта будет создавать заявки.
    ...
    _![Результирующий список аккаунтов](https://kb.comindware.ru/assets/img_6244e46e12ca4.png)_
...
5. Сохраните группу.
    ...
    _![Выбор участников группы «Водители»](https://kb.comindware.ru/assets/img_6316560011972.png)_
...
_![Настройка раздела навигации для сотрудников гаража](https://kb.comindware.ru/assets/img_63165d425dc49.png)_

_![Результирующий список разделов навигации приложения «Управление автопарком»](https://kb.comindware.ru/assets/img_63165d790da30.png)_
...
3. Заполните поля стартовой формы, чтобы создать заявку на автомобиль и запустить бизнес-процесс.
    ...
    _![Панель навигации Заказчика и стартовая форма заявки на автомобиль](https://kb.comindware.ru/assets/img_63165e06bcbf7.png)_
...
3. Откройте задачу _«Рассмотреть заявку»_, дважды нажав её.
    ...
    _![Страница «Мои задачи» для Секретаря](https://kb.comindware.ru/assets/img_63165ea864bbd.png)_
...
5. Выйдите из системы.
    ...
    _![Панель навигации и форма заявки на автомобиль для Диспетчера гаража](https://kb.comindware.ru/assets/img_6316638d89f46.png)_
...
4. Завершите задачу.
    ...
    _![Панель навигации и форма заявки на автомобиль для Водителя](https://kb.comindware.ru/assets/img_63166425945bd.png)_
