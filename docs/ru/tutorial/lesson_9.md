...
- `Затраты` — системное имя атрибута типа «**Запись***» шаблона *«Заявка на автомобиль»*, связанного с шаблоном *«Затраты»*.*
...
2. Нажмите кнопку «**Создать**».
    ...
    _![Создание шаблона экспорта для шаблона записи «<em>Заявка на автомобиль</em>»](https://kb.comindware.ru/assets/img_63175c2c30b3d.png)_
...
4. Сохраните форму.
    ...
    _![Добавление вложенной формы с кнопкой выгрузки отчета на форму задачи «<em>Выполнить рейс</em>»](https://kb.comindware.ru/assets/img_6317c6a560b8b.png)_
...
5. Сохраните роль.
    ...
    _![Добавление для роли «<em>Водитель</em>» разрешения на использование кнопки «<em>Авансовый отчет</em>»](https://kb.comindware.ru/assets/img_6317c77750dd6.png)_
