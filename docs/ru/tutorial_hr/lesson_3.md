...
В ходе этого урока вы усовершенствуете **приложение**, созданное на [предыдущем уроке](lesson_2.md), настроив следующий автоматизированный **процесс** отбора кандидата. На примере процесса «Отбор кандидата на открытую вакансию» вы научитесь моделировать этапы, роли и задачи, используя BPMN-диаграмму, и связывать процесс с данными о кандидатах.
...
3. Перетащите форму _«Кандидаты — Основная форма»_ на макет формы в режиме «**Только чтение**».
...
5. Перетащите в эту область следующие атрибуты:
    - _«Дата и время проведения собеседования»_
    - _«Оценка за прохождение собеседования»_
    - _«Результат собеседования»_
...
5. Добавьте вложенную форму _«Кандидаты — Основная форма»_ в режиме «**Только чтение**».
6. Сохраните форму.
7. Вернитесь к диаграмме процесса, нажав кнопку «**Назад**» в браузере.
