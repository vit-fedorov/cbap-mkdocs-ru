...
- В отдельную область вынести атрибуты из шаблона записи «Кандидаты»: Дата и время собеседования, Оценка за собеседование,
...
4. Нажмите поле атрибута _«Оценка за собеседование»_.
...
14. Введите формулу:
    ...
    !!! question "Синтаксис формулы номера заявки"
        ...
        - `$Оценказапрохождениесобеседования` — атрибут _«Оценка за собеседование»_.
