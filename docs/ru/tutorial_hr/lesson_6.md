...
!!! note "Примечание"
    ...
    Чтобы просмотреть диаграмму _«Оценки за собеседования»_, требуется присвоить раздел навигации какой-нибудь роли, например _HR-менеджер_. Как создать и настроить роли, будет рассказано в [следующем уроке][tutorial_hr_lesson_7].
