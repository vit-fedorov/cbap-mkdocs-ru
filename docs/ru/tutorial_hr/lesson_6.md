...
Настроим состав столбцов и фильтрацию в списке кандидатов.
...
6. Перетащите следующие атрибуты с панели элементов на макет таблицы: _«ФИО»_, _«Результат тестирования»_, _«Оценка за собеседование»_, _«Результаты собеседования»_.

    {% include-markdown ".snippets/tutorial_table_columns_order_admonition.md" %}

7. Сохраните таблицу.
8. Просмотрите результирующие данные в таблице.
