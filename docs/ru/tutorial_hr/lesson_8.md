...
2. Создайте атрибут _«Ссылка на запись»_ со следующими свойствами:
    ...
    _![Настройка атрибута «Ссылка на запись»](img/lesson_8_attribute_link.png)_
...
_![Настройка атрибута «Имя файла»](img/lesson_8_attribute_filename.png)_
...
_![Подготовка шаблона экспорта в Excel](img/_![](img/lesson_8_excel_export_template.png)_.png)_
...
6. В поле «**Имя выходного файла**» выберите пункт «**Значение**» и укажите требуемое имя файла отчёта с данными (без расширения файла), например: `Отчёт о найме`. Файл с указанным именем будет скачивать _HR-менеджер_.
7. Установите флажок «**Экспортировать как PDF**».
8. Сохраните шаблон экспорта.

_![Настройка шаблона экспорта](img/lesson_8_export_template_setting.png)_
...
_![Настройка кнопки «Отчёт о найме»](img/lesson_8_button_settings.png)_
...
7. Сохраните форму.
    ...
    _![Настройка формы «Выгрузка отчёта»](img/lesson_8_form_export.png)_
...
7. Перетащите форму _«Отчёт о найме»_ на таблицу разрешений.
8. Сохраните роль.
...
!!! example "Факультативное задание"
    ...
    Добавьте в отчёт о найме дату создания вакансии из атрибута _«Дата создания»_ с системным именем `_creationDate`, который имеется в каждом шаблоне.
