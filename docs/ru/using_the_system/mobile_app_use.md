...
## Первый вход в {{ productNameMobile }} {: .pageBreak#mobile_app_use_login }
...
7. После входа и прохождения двухфакторной аутентификации задайте и подтвердите код доступа из четырёх цифр. Этот код доступа будет использоваться для последующего входа в **{{ productNameMobile }}** вместо ввода имени пользователя и пароля.
...
## Добавление авторизованного аккаунта {: .pageBreak#mobile_app_use_add_account }
...
## Удаление авторизации аккаунта {: .pageBreak#mobile_app_use_remove_account }
...
## Просмотр Рабочего стола <i class="fa-light fa-house"></i> {: .pageBreak#mobile_app_use_home }
...
## Навигация <i class="fa-light fa-bars"></i> {: .pageBreak#mobile_app_use_navigation }
...
## Поиск данных <i class="fa-light fa-magnifying-glass"></i> {: .pageBreak#mobile_app_use_search }
...
## Сканирование QR-кодов <i class="fa-light fa-qrcode"></i> {: .pageBreak#mobile_app_use_qr_code }
...
## Сканирование NFC/RFID-меток <i class="fa-light fa-qrcode"></i> {: .pageBreak#mobile_app_use_nfc }
...
## Просмотр уведомлений <i class="fa-light fa-bell"></i> {: .pageBreak#mobile_app_use_notifications }
...
## Использование меню <i class="fa-light fa-gear"></i>  {: .pageBreak#mobile_app_use_menu }
...
## Просмотр карточек и таблиц {: .pageBreak#mobile_app_use_cards }
...
## Обсуждение записей {: .pageBreak #mobile_app_use_discussion }
