...
## Настройка фильтрации {: .pageBreakBefore }
...
С помощью форм поиска можно применить расширенную фильтрацию к списку записей в таблице. О настройке форм поиска см. статью _«[Расширенная фильтрация. Настройка форм поиска][search_forms]»_.

1. Нажмите значок <i class="fa-light fa-filter">‌</i> над таблицей.
2. Отобразится панель для настройки расширенной фильтрации.
3. Выберите вкладку с фильтром поиска.
4. Задайте значения атрибутов, по которым следует отфильтровать записи.

   - Чтобы задать тип фильтра, нажмите значок <i class="fa-light  fa-sliders "></i> справа от поля атрибута.

5. Чтобы осуществить фильтрацию записей, нажмите кнопку «**Найти**».
6. Чтобы отменить фильтрацию записей, нажмите кнопку «**Сбросить фильтры**».

Расширенную фильтрацию можно применять одновременно с [фильтрацией на столбцах таблицы](#настройка-фильтрации).
