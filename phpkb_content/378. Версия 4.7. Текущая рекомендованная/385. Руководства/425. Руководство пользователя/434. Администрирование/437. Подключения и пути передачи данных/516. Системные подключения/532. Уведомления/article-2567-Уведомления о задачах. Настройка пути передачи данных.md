...
_![Настройка основных свойств пути передачи данных для уведомлений о задачах](https://kb.comindware.ru/assets/task_notifications_primary_setting.png)_
...
_![Настройка атрибутов сообщения пути передачи данных для уведомлений о задачах](https://kb.comindware.ru/assets/task_notifications_attributes_setting.png)_
...
_![Настройка свойств сообщения пути передачи данных для уведомлений о задачах](https://kb.comindware.ru/assets/task_notifications_message_setting.png)_
