...
- [Отправка, получение и обработка эл. почты в процессе. Пример: настройка подключений, путей передачи данных, диаграммы процесса и сценария](#отправка-получение-и-обработка-эл-почты-в-процессе-пример-настройка-подключений-путей-передачи-данных-диаграммы-процесса-и-сценария)
  - [Введение](#введение)
  - [Прикладная задача](#прикладная-задача)
    - [Исходные данные](#исходные-данные)
      - [Шаблон процесса «Согласование отпуска»](#шаблон-процессасогласование-отпуска)
      - [Шаблон процесса «Обработка ответа руководителя»](#шаблон-процессаобработка-ответа-руководителя)
      - [Атрибуты шаблона записи «Заявления на отпуск»](#атрибуты-шаблона-записизаявления-на-отпуск)
      - [Атрибуты шаблона записи «Решения руководителя»](#атрибуты-шаблона-записирешения-руководителя)
  - [Настройка подключений](#настройка-подключений)
    - [Отправка эл. почты из процесса](#отправка-эл-почты-из-процесса)
  ...
  - [Настройка путей передачи данных](#настройка-путей-передачи-данных)
    - [Отправка уведомления Руководителю](#отправка-уведомления-руководителю)
    - [Получение ответа Руководителя](#получение-ответа-руководителя)
    - [Отправка уведомления «Отпуск согласован»](#отправка-уведомления-отпуск-согласован)
    - [Отправка уведомления «В отпуске отказано»](#отправка-уведомления-в-отпуске-отказано)
  - [Настройка элементов диаграммы процесса «Согласование отпуска»](#настройка-элементов-диаграммы-процесса-согласование-отпуска)
    - [Начальное событие «Оформлено заявление на отпуск»](#начальное-событиеоформлено-заявление-на-отпуск)
    - [Промежуточное событие «Отправка уведомления для руководителя»](#промежуточное-событиеотправка-уведомления-для-руководителя)
    - [Промежуточное событие «Обработан ответ руководителя»](#промежуточное-событиеобработан-ответ-руководителя)
    - [Развилка «Решение руководителя»](#развилкарешение-руководителя)
    - [Конечное событие «Отпуск согласован»](#конечное-событиеотпуск-согласован)
    - [Конечное событие «В отпуске отказано»](#конечное-событиев-отпуске-отказано)
  - [Настройка элементов диаграммы процесса «Обработка ответа руководителя»](#настройка-элементов-диаграммы-процесса-обработка-ответа-руководителя)
    - [Начальное событие «Поступил ответ руководителя»](#начальное-событиепоступил-ответ-руководителя)
    - [Конечное событие «Передача решения в процесс «Согласование отпуска»](#конечное-событиепередача-решения-в-процесс-согласование-отпуска)
