...
Кроме того, потребуется настроить **[начальное](../../../business_apps/diagrams/process_diagram/process_diagram_elements/events/start/receive_message_start_event.html)** или **[промежуточное](../../../business_apps/diagrams/process_diagram/process_diagram_elements/events/intermediate/receive_message_intermediate_event.html) событие-получение сообщения** на диаграмме процесса.
...
3. Настройте **[начальное](../../../business_apps/diagrams/process_diagram/process_diagram_elements/events/start/receive_message_start_event.html)** или [**промежуточное**](../../../business_apps/diagrams/process_diagram/process_diagram_elements/events/intermediate/receive_message_intermediate_event.html) **событие-получение сообщения** на диаграмме процесса:
...
- Передайте значения атрибутов сообщения в атрибуты записи с помощью вкладки «**[Данные сообщения](../../../business_apps/diagrams/process_diagram/process_diagram_elements/events/start/receive_message_start_event.html#данные-сообщения)**» в свойствах **события-получения сообщения**, использующего этот путь передачи данных.
