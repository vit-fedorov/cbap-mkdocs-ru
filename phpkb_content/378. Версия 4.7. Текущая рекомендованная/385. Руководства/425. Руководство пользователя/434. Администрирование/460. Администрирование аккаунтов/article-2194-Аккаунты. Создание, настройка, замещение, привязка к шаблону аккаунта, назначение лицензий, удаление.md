...
Замещение позволяет на заданный период времени назначить вместо аккаунта другие аккаунты в качестве [исполнителей пользовательских задач][roles].
...
Чтобы добавить аккаунту дополнительные атрибуты, изначально не предусмотренные в **Comindware Business Application Platform**, его следует привязать к [шаблону аккаунта][account_templates].
...
Подробные сведения о лицензировании **Comindware Business Application Platform** см. в разделе «**[Лицензирование»][licensing]**.
...
Архивные аккаунты не будут отображаться для включения в [groups][user_task].
