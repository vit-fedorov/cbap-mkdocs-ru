...
Для **[простого начального события][user_task]** на диаграмме процесса можно настроить экранную форму.
...
1. Выберите **[простое начальное событие][none_start_event].
...
1. Выберите **[пользовательскую задачу][user_task].
...
Примечание
    ...
    - При непосредственном редактировании формы **пользовательской задачи** на неё можно поместить атрибуты задачи (которые недоступны на панели элементов в [конструкторе формы][forms].
...
**[Простое начальное событие](https://kb.comindware.ru/article.php?id=2378)**
