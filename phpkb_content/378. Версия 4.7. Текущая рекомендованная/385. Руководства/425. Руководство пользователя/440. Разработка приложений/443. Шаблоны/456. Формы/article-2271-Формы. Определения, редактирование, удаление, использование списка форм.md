...
Примечание
    ...
    - Список форм предусмотрен у шаблонов [записей](https://kb.comindware.ru/article.php?id=2221), [аккаунтов](https://kb.comindware.ru/article.php?id=2223), [ролей](https://kb.comindware.ru/article.php?id=2220) и [организационных единиц](https://kb.comindware.ru/article.php?id=2226).
    - В [шаблоне процесса][process_diagram_forms]  »*  .
...
1. Выберите **[простое начальное событие](https://kb.comindware.ru/article.php?id=2378)** или **[пользовательскую задачу](https://kb.comindware.ru/article.php?id=2392)**в  [конструкторе диаграммы](https://kb.comindware.ru/article.php?id=2356)  .
...
1. **Панель элементов** — палитра [элементов][forms]»:
...
3. Отобразится окно [свойств атрибута][forms].
