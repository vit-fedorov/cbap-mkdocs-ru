...
Подробные сведения см. в статьях *«[Диаграмма Ганта. Настройка][creating_gantt_chart]»* и *«[Диаграмма Ганта. Использование][using_gantt_chart]»*.
...
Подробные сведения см. в статьях *«[Чертёж. Подготовка и импорт файла DWG][drawing_attribute_file_import]»* и *«[Чертёж. Настройка][drawing_attribute_configure]»*.
