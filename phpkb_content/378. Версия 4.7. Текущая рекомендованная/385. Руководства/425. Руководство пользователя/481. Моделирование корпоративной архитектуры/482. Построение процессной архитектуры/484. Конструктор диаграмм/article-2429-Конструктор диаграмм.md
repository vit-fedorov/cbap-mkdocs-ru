...
1. Кнопки типовых операций
    ...
    - **Свойства** *‌* — [настройка свойств][configuring_process_entity_properties] выбранного элемента или всей диаграммы.
2. Кнопки «**Импорт**» *‌* и «**Проверить**» *‌* — позволяют [импортировать][importing_process_entity] и [проверить диаграмму][verify_diagram]. Кнопка «**Проверить**» отображается только для диаграмм процессов. Проверка диаграмм бизнес-способностей не предусмотрена.
