...
_![Настройка раздела навигации для использования модуля Architect](https://kb.comindware.ru/assets/architect_example_navigation_configure.png)_
...
| --- | --- | --- |
| *Тип служебный* | *Tipsluzhebnyy* |  |

**Тип данных: текст** **Вычислять автоматически:** флажок установлен **Вычисляемое выражение: формула**
...
**Тип данных: текст** **Вычислять автоматически:** флажок установлен **Вычисляемое выражение: N3**
...
1. Повторив шаги **1–11**, создайте группу *«Управление и сопровождение»*, а в ней — следующие группы процессов (*расположите их друг под другом и не соединяйте между собой*):
