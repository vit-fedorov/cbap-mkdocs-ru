...
Разделы навигации отображаются в панели навигации слева и позволяют быстро переходить к различным страницам **Comindware Business Application Platform**.
...
В  [следующем уроке](https://kb.comindware.ru/article.php?id=2064)  вы познакомитесь с формированием документов с помощью Comindware Business Application Platform.
