...
- В **шаблоне ревизии** имеются атрибуты **title** и **content**, которые хранят имя файла и ссылку на файл, физически хранящийся в папке `Streams` на сервере **Comindware Business Application Platform**.
