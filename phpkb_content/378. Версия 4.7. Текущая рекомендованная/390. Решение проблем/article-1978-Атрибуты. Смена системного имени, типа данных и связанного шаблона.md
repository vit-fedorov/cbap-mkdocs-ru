...
- восстановить резервную копию экземпляра ПО **Comindware Business Application Platform**, см. статью *«[Резервное копирование. Настройка и запуск, просмотр журнала сеансов][backup]»;*
