...
- **Навигация:** исправлено отображение панели навигации для пользователей без доступа к бизнес-приложениям, использующих **«Архитектор»**.
...
- **Версионирование:** исправлена работа подсистемы версионирования в **«Архитектор»**.
