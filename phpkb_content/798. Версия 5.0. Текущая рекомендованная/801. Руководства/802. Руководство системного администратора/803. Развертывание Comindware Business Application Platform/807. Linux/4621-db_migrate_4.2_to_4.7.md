...
В данной статье представлены краткие инструкции по переносу базы данных (БД) **{{ productName }}** (далее «экземпляр ПО») версии 4.2 из ОС Windows 10 в экземпляр ПО версии 5.0 под управлением ОС Linux.
...
- Установленная утилита миграции *версии 5.0* под управлением ОС Windows для преобразования базы данных.
...
2. Скачайте, разверните и инициализируйте экземпляр ПО.
    - См. *[Развертывание Comindware Platform. Краткое руководство][deploy_guide_linux]*
...
**[Развертывание Comindware Platform. Краткое руководство][deploy_guide_linux]**
