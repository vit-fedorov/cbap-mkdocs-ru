...
В настоящем документе представлены инструкции по установке серверной части ПО **Comindware «Архитектор»** (далее «ПО», экземпляр «ПО»).
...
**ПО** — программное обеспечение **Comindware «Архитектор»**.
...
### 3.3. Развёртывание экземпляра ПО Comindware «Архитектор»
...
4.15. Дождитесь открытия начальной страницы **Comindware «Архитектор»**.

4.16. На этом этапе развёртывание экземпляра ПО завершено и можно приступать к работе.

_![Рисунок 4.5. Начальная страница Comindware «Архитектор»](https://kb.comindware.ru/assets/img_63beae2d4c4e5.png)_
