...
- *Бэкенд*: компоненты-сервисы на основе .NET 6.0, JRE 17, Mono 6.12 (Linux), .NET Framework 4.8 (Windows).
...
- *Модули для интеграции*: см. *«[Интеграция с внешними системами](#интеграция-с-внешними-системами)»*.
