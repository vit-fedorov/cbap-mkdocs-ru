...
Подсистема журналирования **{{ productName }}** использует библиотеку *NLog* (с открытым исходным кодом), которая записывает данные в файлы журналов.
...
Лимит файлов журналов каждого типа задаётся директивой `archiveFilesCount` в файле `logs.config`. См. *«[Описание подсистемы журналирования](#logging_engine_description)»*.
...
_![Пример журнала аудита](/platform/v5.0/administration/deploy/img/logging_engine_audit_log.png)_
...
_![Пример журнала интеграции](/platform/v5.0/administration/deploy/img/logging_engine_integration_log.png)_
...
_![Пример журнала интеграции с сырыми данными](/platform/v5.0/administration/deploy/img/logging_engine_integration_raw.png)_
...
_![Пример журнала исправности](/platform/v5.0/administration/deploy/img/logging_engine_heartbeat_log.png)_
...
_![Пример журнала обновления](/platform/v5.0/administration/deploy/img/logging_engine_update_log.png)_
...
_![Пример журнала ошибок](/platform/v5.0/administration/deploy/img/logging_engine_errror_log.png)_
...
_![Пример журнала процессов](/platform/v5.0/administration/deploy/img/logging_engine_process_log.png)_
...
_![Пример журнала резервного копирования](/platform/v5.0/administration/deploy/img/logging_engine_backup_log.png)_
...
_![Пример журнала сценариев](/platform/v5.0/administration/deploy/img/logging_engine_trigger_log.png)_
...
_![Пример системного журнала](/platform/v5.0/administration/deploy/img/logging_engine_system_log.png)_
...
_![Пример журнала аудита](/platform/v5.0/administration/deploy/img/logging_engine_adapter_log.png)_
