---
title: Аккаунты. Администрирование, замещение, привязка к шаблону аккаунта, назначение лицензий
kbId: 4653
---

# Аккаунты. Администрирование, замещение, привязка к шаблону аккаунта, назначение лицензий
...
_![Список всех аккаунтов в системе](/platform/v5.0/administration/account_administration/img/accounts_page.png)_
...
_![Смена изображения аккаунта](/platform/v5.0/administration/account_administration/img/account_image.png)_
...
_![Настройка замещения](/platform/v5.0/administration/account_administration/img/accounts_substitution_configure.png)_
...
_![Привязка аккаунта к шаблону аккаунта](/platform/v5.0/administration/account_administration/img/account_link_to_template.png)_
...
_![Диспетчер лицензий](/platform/v5.0/administration/account_administration/img/accounts_license_manager.png)_

## Архивирование и разархивирование аккаунтов

Архивные аккаунты не будут отображаться для включения в [groups][groups], в [списках аккаунтов][form_dynamic_elements] на формах, а также в раскрывающихся списках при назначении [исполнителей пользовательских задач][process_diagram_elements_user_task].
