...
В состав **{{ productName }} Enterprise**входит модуль **[«Корпоративная архитектура»](#architect_features)** для моделирования корпоративной архитектуры.
...
## Возможности модуля «Корпоративная архитектура»
