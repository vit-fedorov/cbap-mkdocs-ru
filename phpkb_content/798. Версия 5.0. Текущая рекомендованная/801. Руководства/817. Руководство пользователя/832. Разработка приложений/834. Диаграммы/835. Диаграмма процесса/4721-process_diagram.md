...
# Диаграмма процесса. Определения, просмотр, редактирование, публикация
    ...
    - [Типичные ошибки диаграммы процесса](#process_diagram_error_messages)
        ...
        - [Диаграмма](#диаграмма)
        - [Начальное событие](#начальное-событие)
        - [Простое начальное событие](#простое-начальное-событие)
        - [Конечное событие](#конечное-событие)
        - [Пользовательская задача](#пользовательская-задача)
        - [Развилка «или/или»](#развилка-илиили)
        - [Промежуточное событие-таймер](#промежуточное-событие-таймер)
        - [Промежуточное событие](#промежуточное-событие)
        - [Начальное событие-таймер](#начальное-событие-таймер)
