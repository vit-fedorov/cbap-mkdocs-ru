...
3. Настройте свойства формы:
    ...
    - **Тип**:
        ...
        - **Форма поиска** — выберите этот тип, чтобы настроить расширенную фильтрацию записей. См. *«[Расширенная фильтрация. Настройка форм поиска][search_forms]»* и *«[Таблицы. Расширенная фильтрация][table_personal_use_filter_extended]»*.
