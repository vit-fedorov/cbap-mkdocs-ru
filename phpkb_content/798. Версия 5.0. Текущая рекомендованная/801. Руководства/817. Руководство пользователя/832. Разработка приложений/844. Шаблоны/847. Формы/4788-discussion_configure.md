...
_![Создание обсуждения](https://kb.comindware.ru/assets/discussion_create.png)_
...
3. Настройте конфигурацию обсуждений.
    ...
    - **Отключить прикрепление файлов к обсуждениям** — установите этот флажок, чтобы отключить функцию прикрепления файлов к сообщениям в обсуждениях._![Настройка конфигурации обсуждений в шаблоне](https://kb.comindware.ru/assets/discussion_configure_template.png)_
