...
8. Чтобы удалить элемент, перетащите его за пределы макета.
   ...
   ![Добавление разделителя в группу кнопок](https://kb.comindware.ru/assets/button_area_divide_add.png)

   Добавление разделителя в группу кнопок
...
8. [Настройте область кнопок][button_area].
