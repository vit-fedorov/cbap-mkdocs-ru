...
3. Отобразится раздел «**Ручное управление версиями**» с двумя подразделами:
    ...
    - **Импорт** — импорт версии приложения из репозитория Git._![Страница «Ручное управление версиями»](/platform/v5.0/business_apps/version_control/img/manual_version_control.png)_
...
_![Результат проверки без ошибок](/platform/v5.0/business_apps/version_control/img/manual_version_import_check_no_errors.png)_

_![Результат проверки с ошибками](/platform/v5.0/business_apps/version_control/img/manual_version_import_check_errors.png)_
