...
# Моделирование корпоративной архитектуры. Описание демонстрационного стенда
    ...
    - [Версионирование, согласование и публикация процессов](#версионирование-согласование-и-публикация-процессов)
    - [Аудиты](#аудиты)
    
        - [Добавление KPI для аудита](#добавление-kpi-для-аудита)
...
2. Справа откроется форма с основной информацией о группе процессов:
    ...
    - **Куратор** — в его полномочия входит руководство и управление группой процессов. Выбираем из списка должностей. Пзменение куратора влияет только на процесс *согласования* — с кем требуется согласовать.
...
_![Скачивание файла шаблона экспорта](/platform/v5.0/architect/img/architect_demo_export_template_download.png)_
...
14. Перейдите к исполняемой модели процесса, нажав над диаграммой кнопку «**Мои настройки**» *‌* и выбрав пункт «**Процессы**».
...
2. Чтобы инициировать *Аудит*, помимо согласованной модели процесса заполнитt вкладки «**Числовые KPI**» и «**Списочные KPI**» у модели процесса, по которой мы хотим провести аудит, так как после согласования редактировать данные модели будет невозможно.
...
24. Перейдите в процесс, связанный с записью. Для этого перейдите к исполняемой модели процесса, нажав над диаграммой кнопку «**Мои настройки**» *‌* и выбрав пункт «**Процессы**».
25. Откройте запущенный процесс.
26. Отобразится диаграмма исполняемого процесса, показывающая движение токена, остановившегося на задаче «**Назначить аудитора**».

Логика определения исполнителя задачи назначения аудитора
...
27. Откройте задачу «**Назначить аудитора**».
28. Отобразится форма записи аудита.
29. Выберите в поле «**Аудитор**» любого сотрудника. Список сотрудников фильтруется по отделу «**Аудит**».
30. Нажмите кнопку «**Завершить задачу**».
31. Вернитесь на диаграмму процесса.
...
32. Откройте задачу «**Провести аудит**».
33. Отобразится форма записи аудита и с колонками с фактическими значениями. Аудитор должен заполнить форму и прикрепить отчёт.
34. Выберите вкладку «**Несоответствия**».
...
35. Укажите фактические значения. В одном из числовых показателей укажите значение большее, чем значение «**До**».
36. Завершите задачу.
...
37. Укажите значение, входящее в допустимый диапазон, прикрепите файл в поле «**Отчет**».
38. Завершите задачу.
39. На этом этапе **Аудитор** провел аудит и прикрепил отчёт, процесс **Аудита** завершён.
40. На панели навигации выберите пункты «**Управление архитектурой**» — «**Данные**» — «**Контрольные данные**».
41. Нажмите кнопку «**Аудиты**».
42. Откройте форму записи завершённого только что аудита.
43. Мы провели аудит процесса по показателям KPI, по окончанию которого было направлено уведомление владельцу процесса.
44. Выберите вкладку «**Уведомления**» и просмотрите своё уведомление.
...
1. Выберите пункт «**Рабочий стол**», *где находятся:*
2. Отобразятся следующие разделы:
