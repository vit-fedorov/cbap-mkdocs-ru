...
Для взаимодействия с внешними системами или командами, использующими другие инструменты моделирования **{{ productName }} Enterprise** позволяет импортировать и экспортировать диаграммы в формате `.BPMN`.
...
- [Просмотр и редактирование диаграмм процессов и бизнес-способностей][architect_process_architecture_diagram_designer]
