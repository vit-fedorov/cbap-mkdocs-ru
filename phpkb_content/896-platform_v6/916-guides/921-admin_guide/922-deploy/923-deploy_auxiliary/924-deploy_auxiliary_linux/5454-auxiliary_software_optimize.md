...
1. Откройте файл конфигурации OpenSearch (Elasticsearch): `/etc/opensearch/opensearch.yml`
2. Установите требуемое количество шардов с помощью директивы `cluster.max_shards_per_node`:
   ...
   Значение в 3000 шардов является минимально рекомендуемым количеством, которое определено на основе практического опыта эксплуатации {{ productName }}.
...
1. Откройте файл конфигурации JVM OpenSearch (Elasticsearch): `/etc/opensearch/jvm.options`
