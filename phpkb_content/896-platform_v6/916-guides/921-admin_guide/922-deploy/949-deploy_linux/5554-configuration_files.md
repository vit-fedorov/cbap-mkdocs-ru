...
В **{{ productName }} 6.0** системные службы настраиваются с помощью [файла конфигурации экземпляра ПО](#configuration_files_linux_instance).
...
Инструкции по обновлению конфигурации с версий 4.7.x или 5.0 на версию 6.0 см. в статье *«[Обновление версии экземпляра ПО с его остановкой][upgrade_version_linux]»*.
