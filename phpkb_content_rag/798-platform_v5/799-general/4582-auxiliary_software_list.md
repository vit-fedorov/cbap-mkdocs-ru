...
Некоторые функции **Comindware Platform** реализованы с использованием сторонних библиотек.

Для обеспечения работы **Comindware Platform** используются сторонние сервисы, такие как веб-сервер, СУБД, обратный прокси-сервер и т. п.

Здесь представлен перечень стороннего программного обеспечения (ПО), которое поставляется вместе с **Comindware Platform** версии 5.0 для операционных систем (ОС) семейства Linux: «Альт Сервер» и Astra Linux.

Состав стороннего ПО для других операционных систем может отличаться.

## Компоненты фронтенда (браузерной части)

Перечисленное ниже ПО входит в состав браузерной клиентской части **Comindware Platform** для любых ОС.
...
| [vanilla-text-mask](https://www.npmjs.com/package/vanilla-text-mask) | JavaScript-функция, обеспечивающая использование масок в HTML-элементе . | 5.1.1 | Unlicense License |

## Компоненты бэкенда

Перечисленное ниже ПО входит в состав **Comindware Platform** и обеспечивает работу её серверной части.
...
Перечисленное ниже вспомогательное ПО используется для работы **Comindware Platform** под управлением ОС «Альт Сервер».
...
Перечисленное ниже вспомогательное ПО используется для работы **Comindware Platform** под управлением ОС Astra Linux.
