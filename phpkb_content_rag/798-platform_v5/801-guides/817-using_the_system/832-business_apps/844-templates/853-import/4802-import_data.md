...
_![Настройка импорта данных из файла CSV](/platform/v5.0/business_apps/templates/img/import_settings.png)_
...
1. Создайте [accounts](https://kb.comindware.ru/article.php?id=4653) с перечисленными ниже **Ф. И. О.**: *Иванов И. И., Кулагина А. Н., Филиппов К. В., Журавлёва Т. С., Игнатьев А. Б.* Остальные свойства аккаунтов заполните произвольными сведениями.
...
5. Нажмите кнопку «**Загрузить**».
   ...
   ![Настройка импорта данных в шаблон «Заявления на отпуск»](/platform/v5.0/business_apps/templates/img/import_settings_to_vacations.png)
...
8. Заявление № 1 должно быть обновлено и должны появиться три новых заявления в соответствии с импортированными данными.
   ...
   ![Импортированные заявления на отпуск](/platform/v5.0/business_apps/templates/img/import_added_records_to_vacation.png)
...
12. Нажмите кнопку «**Загрузить**».
    ...
    ![Настройка импорта данных в шаблон «Решения по заявлениям на отпуск»](/platform/v5.0/business_apps/templates/img/import_data_settings.png)
...
17. Отобразится два решения, каждое по двум заявлениям на отпуск.
    ...
    ![Импортированные решения по заявлениям на отпуск](/platform/v5.0/business_apps/templates/img/import_added_records_to_decisions.png)
