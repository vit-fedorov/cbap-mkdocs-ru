...
- [настроить приложение](#document_digital_signature_nastroyka_prilozheniya) в **Comindware Platform** для использования ЭП.
...
5. В шаблоне *«Договоры»* создайте кнопку *«Добавить подписанта»*:
   ...
   - в поле «**Результат выполнения**» выберите пункт «**Обновить данные**».![Создание кнопки «Добавить подписанта»](/platform/v5.0/examples/img/document_digital_signature_create_button.png)
...
7. В разделе приложения «**Сценарии**» создайте сценарий *«Добавить подписанта»*.
   ...
   Соответственно, для подписания документа в данном примере сценарий записывает в атрибут *«Подписанты»* текущего документа идентификатор аккаунта текущего пользователя (вычисляемый с помощью функции `USER()`).
8. Настройте свойства начального события сценария «**Нажать кнопку**»:

   - в поле «**Контекстный шаблон**» выберите шаблон *«Документы»*;
   - в поле «**Кнопка**» выберите кнопку *«Добавить подписанта»*, созданную на шаге 5.![Настройка свойств события «Нажатие кнопки» в сценарии](https://kb.comindware.ru/assets/img_633424ef7f1a5.png)
...
12. Настройте свойства блока «**Изменить значения атрибутов**»:
    ...
    - в столбце «**Значение**» выберите пункт «**Формула**» и введите формулу: `USER()`![Настройка свойств события «Изменить значения атрибутов» в сценарии](https://kb.comindware.ru/assets/img_633424a369e98.png)
...
3. Нажмите кнопку *«Добавить подписанта»*.
