...
| POST | /Base/OntologyService/CreateIgniteCache |
| --- | --- |
...
| POST | /Base/OntologyService/ScheduleCleaningOldSchemeCaches |
| --- | --- |
| **Описание** | Планирует очистку устаревших кэшей схем. |
| **Параметры** | Количество элементов к очистке. |
| **Ответ** | Логическое значение `true`/`false`. |

| POST | /Base/OntologyService/ClearAllPersonalData |
| --- | --- |
...
См. *[Пример создания ссылки на внешнюю форму](https://kb.comindware.ru/article.php?id=5726#form_access_control_external_link)*.
