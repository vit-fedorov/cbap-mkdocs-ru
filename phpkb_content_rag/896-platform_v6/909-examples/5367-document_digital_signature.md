...
5. В шаблоне *«Договоры»* создайте кнопку *«Добавить подписанта»*:
   ...
   - в поле «**Результат выполнения**» выберите пункт «**Обновить данные**».![Создание кнопки «Добавить подписанта»](/platform/v6.0/examples/img/document_digital_signature_create_button.png)
